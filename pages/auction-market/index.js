...
const sensors = useSensors(
  ...
  useEffect(() => {
   captureIXEvent("auction_market_viewed", {
  page: "auction-market"
});
  }, []);
 ...
 useEffect(() => {
  ...
  async function loadAuctionMarketEnvironment() {
    try {
      const environment =
...
if (workspaceLayout.activeStackLayouts) {
  setActiveStackLayouts(current => ({
    ...
    ...workspaceLayout.activeStackLayouts
      ...
      console.log(
        "IXI AUCTION MARKET ENVIRONMENT",
        {
      ...
      console.error(
        "IXI AUCTION MARKET LOAD FAILED:",
        error
      );
...
const sellerName = "";
const sellerLocation = "Auction Company and Event Index";
const sellerLogo = "";
...
function recoverSellerObject(sellerObject) {
  ...
  return (
    <>
            <Head>
        <title>IXI Auction MKT | IronXchange</title>
...
<section className="yard-head">
  <div className="yard-identity">
    ...
    <div className="yard-copy">
      <span className="eyebrow">IXI Auction Market</span>
