  ...
  * {
  ...
  .ixi-pocket-thumbs {
    ...
    background:
      ...
      linear-gradient(0deg, rgba(255,255,255,.02), transparent 30%),
      rgba(10,10,10,.44);
    pointer-events: auto;
    z-index: 30;
  }
  ...
  :global(.active-stack-tray) {
    ...
    border-radius: 10px;
    background:
      linear-gradient(180deg, rgba(255,196,0,.035), rgba(255,196,0,.008) 48%, rgba(255,255,255,.010)),
      rgba(8,8,8,.86);
    box-shadow:
