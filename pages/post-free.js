...
const previewListing = {
  ...
  model,
  hours,
  price: price ? `$${Number(cleanNumber(price)).toLocaleString()}` : "Price",
...
main {
 ...
 .preview-panel {
  ...
  border: 1px solid rgba(56,161,105,.24);
  border-radius: 999px;

  background:
    linear-gradient(180deg, rgba(56,161,105,.08), rgba(56,161,105,0)),
    #101010;
