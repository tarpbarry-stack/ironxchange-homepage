...
export default function BulkImportPage() {
  ...
  return (
    <>
      <Head>
        <title>Bulk Import | IronXchange</title>
      ...
      <main>
        ...
        <section className="v12-shell">
          <div className="v12-panel">
            <span>IronXchange Intake System</span>
            <h1>Bulk Import</h1>
            <p>
              Upload dealer inventory by spreadsheet or structured file. This page is staged for the V12 bulk machine intake workflow.
            </p>
