...
export default function IXISellerMachineObjectFace2({
  ...
  return (
    <section className="mof2" {...(dragHandleProps || {})}>
      ...
      <div className="mof2-actions-stack" onPointerDown={event => event.stopPropagation()}>
        <div className="mof2-action-row mof2-contact-row">
          <button type="button">EMAIL</button>
          <button type="button">TEXT</button>
          <button type="button">PDF</button>
        </div>
        <div className="mof2-action-row mof2-lifecycle-row">
      ...
      <style jsx>{`
        .mof2{box-sizing:border-box;width:100%;max-width:100%;height:378px;min-height:378px;max-height:378px;position:relative;padding:10px 14px 10px;display:flex;flex-direction:column;align-items:center;text-align:center;background:radial-gradient(circle at top,rgba(255,196,0,.05),transparent 42%),linear-gradient(180deg,rgba(255,255,255,.028),rgba(255,255,255,0)),#141414;color:#f2f2f2}
