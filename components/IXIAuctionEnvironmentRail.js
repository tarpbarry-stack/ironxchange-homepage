...
const RAIL_ITEMS = [
  ...
  { label: "IXI AUCTION WRK", href: "/auction-work", access: "relationship" },
...
export default function IXIAuctionEnvironmentRail({
...
>
      ...
      <button
       ...
       aria-label="Toggle auction environment rail"
title="IXI Auction Environment"
      />
