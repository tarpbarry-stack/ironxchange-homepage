...
export default function IXISoldDetails({ listing, onOpenTransact }) {
  ...
  return <section className="sold-facts" aria-label="Sale details">
    ...
    <style jsx>{`
      .sold-facts{flex:1;min-height:0;display:flex;flex-direction:column;gap:6px;color:#f3f3f3;font-family:'IXI Sold Inter','Inter Variable',Inter,ui-sans-serif,sans-serif}
      .identity{display:flex;justify-content:space-between;gap:6px;color:#b0b0b0;font-size:9px;line-height:1.4;font-weight:450;flex-wrap:wrap}
      .sale-price{display:flex;align-items:baseline;justify-content:space-between;gap:8px;padding:6px 0;border-top:1px solid #414141;border-bottom:1px solid #414141}
      .sale-price span{font-size:10px;line-height:1.4;letter-spacing:.035em;font-weight:600;color:#bfbfbf}
      ...
      dt{font-size:9px;line-height:1.4;letter-spacing:.035em;color:#b5b5b5;font-weight:600}
      ...
      .sold-actions button{background:#efc500;border:1px solid #ffe568;color:#191919;font-family:inherit;font-size:10px;line-height:1.4;font-weight:750;padding:8px 9px;cursor:pointer;border-radius:4px;white-space:nowrap}
