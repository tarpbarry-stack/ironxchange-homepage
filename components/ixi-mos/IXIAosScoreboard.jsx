  ...
  return (
    <section className="aos-scorecard">
      ...
      <style jsx>{`
        ...
        .aos-scorecard-name strong { overflow: hidden; white-space: nowrap; text-overflow: ellipsis; color: #e6eee6; font-size: 12px; font-weight: 800; text-transform: uppercase; }
        .aos-scorecard-name span { color: #acb9ab; font-size: 10px; text-transform: uppercase; }
        .aos-scorecard-metrics { display: grid; grid-template-columns: repeat(5, minmax(0, 1fr)); align-items: center; min-width: 0; }
        .aos-metric { min-width: 0; display: flex; flex-direction: column; gap: 7px; border-left: 1px solid #364535; padding: 0 14px; }
        .aos-metric span { color: #a6b59f; font-size: 9px; font-weight: 700; letter-spacing: .05em; line-height: 1.4; }
        ...
        .aos-scorecard-action { width: 30px; height: 30px; display: grid; place-items: center; padding: 0; border: 1px solid #42503b; border-radius: 5px; background: #233020; color: #e0c65b; font-size: 11px; cursor: pointer; }
