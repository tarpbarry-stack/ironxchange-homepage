...
const FIXTURE = Object.freeze({
  ...
  location: "Abilene, TX",
  price: "$315,000",
  serialNumber: "DEMO-WA475-001",
  stockNumber: "DEMO-1047",
  sellerCompany: "ATLAS DEMONSTRATION",
  description: "Sample wheel loader for learning the IXI controls. Tier 4 engine, quick coupler and 4,812 operating hours. This demonstration machine is not offered for sale.",
...
export default function IXIAtlasLiveTestCell({ selected, onSelect, part }) {
  ...
  const sendFront = useCallback(() => record("RAIL / 01", "depth.forward", "DEMO: FRONT COMMAND CAPTURED"), [record]);
  const sendBack = useCallback(() => record("RAIL / 07", "depth.backward", "DEMO: BACK COMMAND CAPTURED"), [record]);
  ...
  const deliverToArmedDestination = useCallback(() => {
    record("RAIL / 06", "destination.sync", railDestinationArmed ? "DEMO: DELIVERY COMMAND CAPTURED" : "NO DESTINATION ARMED");
