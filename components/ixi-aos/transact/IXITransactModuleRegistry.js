export const IXI_TRANSACT_MODULES = Object.freeze([
  ...
  Object.freeze({ id: "asset-move", label: "ASSET MOVE", group: "asset", documentType: "asset-move" }),
  Object.freeze({ id: "freight", label: "FREIGHT", group: "move", documentType: "freight" }),
