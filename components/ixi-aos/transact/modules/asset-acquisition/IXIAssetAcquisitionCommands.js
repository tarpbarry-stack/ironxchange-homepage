    ...
    operation: async () => {
      ...
      const response = await createIXIAosObjectFinancialDocument({
        ...
        input: {
          ...
          sourceFinancialDocumentId: clean(draft.trade?.sourceFinancialDocumentId),
        ...
        metadata: {
          ...
          ...(draft.trade ? { dealId: draft.trade.dealId, tradeId: draft.trade.tradeId, trade: draft.trade } : {}),
