...
export default function IXIRentalExpenseApp({
  ...
  return <div className="ixi-rentexp">
    ...
    <div className="rent-grid2"><Field label={t.rate}><IXIMoneyInput value={baseRate} onValueChange={setBaseRate} inputMode="decimal" /></Field><Field label={t.rateUnit}><select value={rateUnit} onChange={event => setRateUnit(event.target.value)}><option value="hour">HOUR</option><option value="day">DAY</option><option value="week">WEEK</option><option value="month">MONTH</option></select></Field></div>
    <div className="rent-grid2"><Field label={t.included}><Input value={includedUsage} onChange={setIncludedUsage} inputMode="decimal" /></Field><Field label={t.overage}><IXIMoneyInput value={overageRate} onValueChange={setOverageRate} inputMode="decimal" /></Field></div>
    ...
    <div className="rent-grid2"><Field label={t.delivery}><IXIMoneyInput value={deliveryCharge} onValueChange={setDeliveryCharge} inputMode="decimal" /></Field><Field label={t.pickup}><IXIMoneyInput value={pickupCharge} onValueChange={setPickupCharge} inputMode="decimal" /></Field><Field label={t.waiver}><IXIMoneyInput value={damageWaiver} onValueChange={setDamageWaiver} inputMode="decimal" /></Field><Field label={t.insurance}><IXIMoneyInput value={insurance} onValueChange={setInsurance} inputMode="decimal" /></Field><Field label={t.deposit}><IXIMoneyInput value={deposit} onValueChange={setDeposit} inputMode="decimal" /></Field><Field label={t.environmental}><IXIMoneyInput value={environmentalFee} onValueChange={setEnvironmentalFee} inputMode="decimal" /></Field></div>
    <Field label={t.tax}><IXIMoneyInput value={taxesEstimate} onValueChange={setTaxesEstimate} inputMode="decimal" /></Field>
