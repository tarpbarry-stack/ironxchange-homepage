...
export default function IXIGeneralLedgerApp({
  ...
  return <div className="ixi-gl" style={{ width: 298, height: 471, overflowY: "auto", overflowX: "hidden" }}>
    ...
    {locked ? <div className="gl-callout">GENERAL LEDGER IS DENY-BY-DEFAULT. AUTHENTICATED FINANCIAL GL VIEW AUTHORITY IS REQUIRED.</div> : <>
      ...
      mode === "mappings" ? <><div className="gl-section">POSTING RULE GOVERNANCE</div><div className="gl-callout">POSTING RULES ARE IX CORE-GOVERNED. BROWSER RULE MUTATION IS DISABLED UNTIL A VERSIONED, AUDITED SERVER COMMAND IS AVAILABLE.</div><div className="gl-check"><span>CLIENT-SIDE RULE CHANGES</span><b className="gl-good">DISABLED</b></div><div className="gl-check"><span>ACTIVE RULES</span><b>{rules.length}</b></div></> :
