...
export default function IXIAosCard007EmployeeApplication({
  ...
  return (
    <div className="employee007-app">
        ...
        <div className="employee007-editor" onPointerDown={event => event.stopPropagation()}>
          ...
          <div className="employee007-editor-scroll">
            ...
            <section className="capability-editor">
              <div className="capability-title">CAPABILITIES / SPECIAL SKILLS</div>
      ...
      <style jsx>{`
        .employee007-app{position:relative;width:298px;height:471px}.employee007-editor{position:absolute;inset:42px 7px 19px;z-index:250;overflow:hidden;border:1px solid #4b524e;border-radius:6px;background:rgba(7,9,8,.985);box-shadow:0 16px 34px #000d;color:#fff;font-family:Arial,sans-serif}.employee007-editor-head{height:31px;display:flex;align-items:center;justify-content:space-between;padding:0 7px;border-bottom:1px solid #343a35;background:#121613}.employee007-editor-head strong{color:#ffc400;font-size:7px}.employee007-editor-head div{display:flex;gap:3px}.employee007-editor-head button{height:20px;padding:0 7px;border:1px solid #454c47;border-radius:3px;background:#0c0f0d;color:#ffc400;font-size:6px;font-weight:950}.employee007-editor-scroll{position:absolute;inset:31px 0 0;overflow-y:auto;padding:7px}.employee007-editor label{display:block;margin-bottom:6px}.employee007-editor label span,.capability-title{display:block;margin-bottom:3px;color:#9ea6a1;font-size:5px;font-weight:950}.employee007-editor input{width:100%;height:24px;padding:0 6px;border:1px solid #343a35;border-radius:3px;background:#111512;color:#fff;font-size:7px;font-weight:800;outline:none}.employee007-editor input:focus{border-color:rgba(255,196,0,.55)}.employee007-editor .two{display:grid;grid-template-columns:1fr 1fr;gap:5px}.capability-editor{margin-top:3px;padding-top:7px;border-top:1px solid #303631}.capability-title{color:#ffc400}.capability-list{display:flex;flex-wrap:wrap;gap:4px;margin-bottom:6px}.capability-list button{height:22px;padding:0 6px;border:1px solid #3d4540;border-radius:11px;background:#171c18;color:#e8ebe9;font-size:6px;font-weight:850}.capability-list b{margin-left:5px;color:#ff7a65}.capability-add{display:grid;grid-template-columns:1fr 42px;gap:4px}.capability-add button{border:1px solid rgba(255,196,0,.45);border-radius:3px;background:#17150b;color:#ffc400;font-size:6px;font-weight:950}
      `}</style>
    </div>
  );
}
