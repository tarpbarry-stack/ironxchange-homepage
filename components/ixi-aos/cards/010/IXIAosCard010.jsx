...
function withFaceLabSample(object = {}) {
  const isPreview = object?.metadata?.source === "aos-card-catalog-preview";
  const hasFields = Object.keys(object?.fields || {}).length > 0;
  if (!isPreview || hasFields) return object;
  ...
  return {
    ...
    fieldDefinitions: [
      ...
      { fieldId: "status", label: "STATUS", type: "text", editable: true, presentationOrder: 2 },
      { fieldId: "manufacturer", label: "MANUFACTURER", type: "text", editable: true, presentationOrder: 3 },
      { fieldId: "model", label: "MODEL / SPEC", type: "text", editable: true, presentationOrder: 4 },
      { fieldId: "serial", label: "SERIAL / REFERENCE", type: "text", editable: true, presentationOrder: 5 },
      { fieldId: "capacity", label: "RATED CAPACITY", type: "text", editable: true, presentationOrder: 6 },
      { fieldId: "commissioned", label: "COMMISSIONED", type: "text", editable: true, presentationOrder: 7 },
      { fieldId: "inspection", label: "LAST INSPECTION", type: "text", editable: true, presentationOrder: 8 },
      { fieldId: "owner", label: "RESPONSIBLE GROUP", type: "text", editable: true, presentationOrder: 9 }
    ],
    fields: {
      businessIdentifier: "A-17",
      classification: "ROTARY SCREW",
      status: "ACTIVE",
      manufacturer: "ATLAS COPCO",
      model: "GA 90 VSD+",
      serial: "APF-22-41871",
      capacity: "125 HP · 460 V",
      commissioned: "APR 2022",
      inspection: "AUG 04, 2026",
...
export default function IXIAosCard010(props) {
    ...
    <IXIAosDataContractCardAdapter {...props} object={object} minimumCustomFields={9}>
      {contractProps => (
        <IXIAosFace1CardRuntime object={contractProps.object} onSaveObject={contractProps.onSaveObject} maxFields={9}>
          {face1 => <IXIAosGenericDataDominant010 {...contractProps} object={face1.object} onSaveObject={face1.onSaveObject} />}
