...
export default function IXIAosGenericAgreement015({
  ...
  return (
    <article className="ixi-card-015" data-card-number="015" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        .ixi-card-015,.ixi-card-015 *{box-sizing:border-box}.ixi-card-015{--y:#ffc400;--line:#383838;--soft:#292929;position:relative;width:298px;height:471px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:radial-gradient(circle at 82% 12%,#17495e1d,transparent 25%),linear-gradient(180deg,#131313,#0a0a0a);color:#f4f4f4;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .c015-head{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}.c015-identity{max-width:188px}.c015-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c015-identity h2{margin:3px 0 0;font-size:13px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c015-identity small{display:block;margin-top:4px;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .c015-body{position:absolute;top:48px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.c015-state{flex:0 0 54px;display:grid;grid-template-columns:1.2fr .8fr;gap:5px}.c015-state>div,.c015-state aside{display:flex;flex-direction:column;justify-content:center;padding:0 9px;border:1px solid var(--line);border-radius:5px;background:#131313}.c015-state>div{border-color:#5b5540}.c015-state span,.c015-state small,.c015-parties span,.c015-dates span,.c015-extra span{color:#919191;font-size:5px;font-weight:950;letter-spacing:.05em}.c015-state>div span{color:var(--y)}.c015-state strong{margin-top:4px;color:#f5f5f5;font-size:15px;font-weight:950}.c015-state aside b{margin-top:4px;overflow:hidden;color:#dcdcdc;font-size:7px;text-overflow:ellipsis;white-space:nowrap}
        .c015-parties{flex:0 0 52px;display:grid;grid-template-columns:1fr 1fr;gap:5px}.c015-parties>div{min-width:0;display:flex;flex-direction:column;justify-content:center;padding:0 8px;border:1px solid var(--line);border-radius:5px;background:#121212}.c015-parties strong{margin-top:4px;overflow:hidden;color:#f0f0f0;font-size:7.5px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}
        .c015-dates{flex:0 0 74px;display:grid;grid-template-columns:1fr 1fr;gap:5px}.c015-dates>div{display:flex;flex-direction:column;justify-content:center;padding:0 8px;border:1px solid var(--line);border-radius:5px;background:#121212}.c015-dates strong{margin-top:4px;color:#f0f0f0;font-size:7px;font-weight:950}.c015-dates>div:nth-child(2) strong{color:var(--y)}
        .c015-obligation{flex:0 0 64px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c015-title{height:19px;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.05em}.c015-obligation p{height:44px;margin:0;padding:8px;color:#e2e2e2;font-size:7px;font-weight:800;line-height:1.35;overflow:hidden}
        .c015-extra{flex:0 0 42px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:5px;overflow:hidden}.c015-extra>div{display:flex;flex-direction:column;justify-content:center;padding:0 8px;border:1px solid var(--line);border-radius:5px;background:#121212}.c015-extra strong{margin-top:3px;overflow:hidden;color:#e7e7e7;font-size:6.5px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}
        .c015-relations{min-height:0;flex:1;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c015-scroll{height:calc(100% - 19px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#535353 transparent}.c015-scroll::-webkit-scrollbar,.c015-editor main::-webkit-scrollbar{width:4px}.c015-scroll::-webkit-scrollbar-thumb,.c015-editor main::-webkit-scrollbar-thumb{border-radius:3px;background:#535353}.c015-scroll button{width:100%;height:31px;display:flex;align-items:center;justify-content:space-between;padding:0 7px;border:0;border-bottom:1px solid var(--soft);background:transparent;color:#fff;text-align:left}.c015-scroll small{display:block;color:#787878;font-size:4.5px;font-weight:900}.c015-scroll strong{display:block;margin-top:2px;font-size:6.5px}.c015-empty{padding:10px;color:#646464;font-size:5px;font-weight:900}
        .c015-commands{position:absolute;left:0;right:0;bottom:23px;height:28px;display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid #343434;background:#0f0f0f}.c015-commands button{border:0;border-right:1px solid #292929;background:transparent;color:#939393;font-size:8px}.c015-commands b{margin-left:3px;font-size:5px;letter-spacing:.05em}.c015-commands button:hover{color:var(--y)}
        .c015-editor{position:absolute;inset:0;z-index:90;background:#0b0b0b}.c015-editor header{height:46px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #383838;background:#171717}.c015-editor header small{display:block;color:#797979;font-size:5px;font-weight:900}.c015-editor header strong{display:block;margin-top:2px;color:var(--y);font-size:8px}.c015-editor nav{display:flex;gap:4px}.c015-editor button{height:24px;padding:0 8px;border:1px solid #404040;border-radius:4px;background:#131313;color:#eaeaea;font-size:5px;font-weight:950}.c015-editor main{position:absolute;top:46px;bottom:0;left:0;right:0;overflow-y:auto;padding:9px}.c015-editor label{display:block;margin-bottom:8px}.c015-editor label span{display:block;margin-bottom:3px;color:#919191;font-size:5px;font-weight:950}.c015-editor input{width:100%;height:28px;padding:0 7px;border:1px solid #3a3a3a;border-radius:4px;background:#121212;color:#f4f4f4;font-size:7px;outline:none}.c015-editor input:focus{border-color:#887019}
      `}</style>
    </article>
  );
}
