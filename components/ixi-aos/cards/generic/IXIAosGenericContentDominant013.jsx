...
export default function IXIAosGenericContentDominant013({
  ...
  return (
    <article className="ixi-card-013" data-card-number="013" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        .ixi-card-013,.ixi-card-013 *{box-sizing:border-box}.ixi-card-013{--y:#ffc400;--cyan:#00c2ff;--line:#383838;--soft:#292929;position:relative;width:${W}px;height:${H}px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:radial-gradient(circle at 84% 12%,#17495e1c,transparent 26%),linear-gradient(180deg,#131313,#0a0a0a);color:#f4f4f4;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .c013-head{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}.c013-identity{max-width:188px}.c013-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c013-identity h2{margin:3px 0 0;color:#f8f8f8;font-size:13px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c013-identity small{display:block;margin-top:4px;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .c013-body{position:absolute;top:48px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.c013-content{flex:0 0 151px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#0d0d0d}.c013-content-title,.c013-title{height:21px;display:flex;align-items:center;justify-content:space-between;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818}.c013-content-title span,.c013-title span{color:var(--y);font-size:6px;font-weight:950;letter-spacing:.05em}.c013-content-title a{color:var(--cyan);font-size:5px;font-weight:950;text-decoration:none}.c013-preview{height:129px;overflow:hidden;background:linear-gradient(135deg,#0f0f0f,#141414)}.c013-preview>img{width:100%;height:100%;display:block;object-fit:contain;background:#0b0b0b}.c013-file{height:100%;display:grid;grid-template-columns:82px 1fr;align-items:center;gap:12px;padding:12px 14px;background:linear-gradient(135deg,#111111,#181818)}.c013-file-badge{height:96px;display:flex;flex-direction:column;align-items:center;justify-content:center;border:1px solid #4f4f4f;border-radius:4px;background:linear-gradient(180deg,#1a1a1a,#0d0d0d);box-shadow:inset 0 1px #ffffff0d}.c013-file-badge b{color:var(--y);font-size:14px;letter-spacing:.08em}.c013-file-badge strong{margin-top:9px;color:#ebebeb;font-size:9px}.c013-file-copy{min-width:0;display:flex;flex-direction:column}.c013-file-copy span{color:#838383;font-size:5px;font-weight:950}.c013-file-copy strong{margin-top:7px;display:-webkit-box;overflow:hidden;color:#f3f3f3;font-size:9px;line-height:1.2;font-weight:950;-webkit-line-clamp:3;-webkit-box-orient:vertical}.c013-file-copy small{margin-top:8px;color:#797979;font-size:5px;font-weight:850;text-transform:uppercase}.c013-empty-preview{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px}.c013-empty-preview>div{display:flex;align-items:center;gap:9px}.c013-empty-preview b{display:grid;place-items:center;width:35px;height:35px;border:1px solid #ffc40055;border-radius:4px;color:var(--y);font-size:9px}.c013-empty-preview strong{color:#878787;font-size:9px;letter-spacing:.08em}.c013-empty-preview span{color:#5f5f5f;font-size:5px;font-weight:900;letter-spacing:.08em}
        .c013-facts{flex:0 0 49px;display:grid;grid-template-columns:1.2fr .72fr .9fr;gap:5px}.c013-facts>div,.c013-validity>div,.c013-extra>div{min-width:0;display:flex;flex-direction:column;justify-content:center;padding:0 7px;border:1px solid var(--line);border-radius:5px;background:#131313}.c013-facts span,.c013-validity span,.c013-extra span{color:#858585;font-size:4.8px;font-weight:950;letter-spacing:.04em}.c013-facts strong,.c013-validity strong,.c013-extra strong{margin-top:4px;overflow:hidden;color:#f0f0f0;font-size:7px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}.c013-facts>div:last-child strong{color:var(--y)}
        ...
        .c013-relations{min-height:0;flex:1;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c013-title>b{display:grid;place-items:center;min-width:20px;height:13px;padding:0 4px;border:1px solid #ffffff10;border-radius:7px;background:#0e0e0e;color:#8f8f8f;font-size:5px}.c013-relation-scroll{height:calc(100% - 21px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#535353 transparent}.c013-relation-scroll::-webkit-scrollbar,.c013-editor main::-webkit-scrollbar{width:4px}.c013-relation-scroll::-webkit-scrollbar-track,.c013-editor main::-webkit-scrollbar-track{background:transparent}.c013-relation-scroll::-webkit-scrollbar-thumb,.c013-editor main::-webkit-scrollbar-thumb{border-radius:3px;background:#535353}.c013-relation-scroll::-webkit-scrollbar-thumb:hover,.c013-editor main::-webkit-scrollbar-thumb:hover{background:#7b6a20}.c013-relation-scroll button{width:100%;height:31px;display:grid;grid-template-columns:minmax(0,1fr) 15px;align-items:center;padding:0 7px;border:0;border-bottom:1px solid var(--soft);background:transparent;color:#fff;text-align:left}.c013-relation-scroll button>span{min-width:0;display:flex;flex-direction:column}.c013-relation-scroll small{color:#787878;font-size:4.7px;font-weight:900}.c013-relation-scroll strong{margin-top:2px;overflow:hidden;color:#ebebeb;font-size:6.5px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}.c013-relation-scroll em{color:#6d6d6d;font-size:4.5px}.c013-relation-scroll button>b{color:#6f6f6f;font-size:10px;text-align:right}.c013-no-rel{height:100%;display:grid;place-items:center;color:#5f5f5f;font-size:5px;font-weight:900}
        .c013-commands{position:absolute;left:7px;right:7px;bottom:24px;height:24px;display:grid;grid-template-columns:repeat(3,1fr);gap:5px;z-index:20}.c013-commands button{border:1px solid #333333;border-radius:4px;background:#131313;color:var(--cyan);font-size:7px;font-weight:950}.c013-commands b{margin-left:3px;color:#aeaeae;font-size:5.5px}
        .c013-editor{position:absolute;inset:0;z-index:120;background:#0d0d0d}.c013-editor header{height:46px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #343434;background:#161616}.c013-editor header small{display:block;color:var(--y);font-size:5px;font-weight:950}.c013-editor header strong{display:block;margin-top:3px;font-size:10px}.c013-editor nav{display:flex;gap:4px}.c013-editor nav button{height:22px;padding:0 7px;border:1px solid #4d4d4d;border-radius:4px;background:#131313;color:#e1e1e1;font-size:5.5px;font-weight:950}.c013-editor nav button:first-child{border-color:#6b5d1c;color:var(--y)}.c013-editor main{position:absolute;top:46px;left:0;right:0;bottom:0;overflow-y:auto;padding:8px}.c013-editor label{display:block;margin:6px 0}.c013-editor label span{display:block;margin-bottom:3px;color:#929292;font-size:5px;font-weight:950}.c013-editor input{width:100%;height:26px;padding:0 7px;border:1px solid #383838;border-radius:4px;background:#121212;color:#f0f0f0;font-size:7px;font-weight:850;outline:none}.c013-editor input:focus{border-color:#7b6a20}
      `}</style>
    </article>
  );
}
