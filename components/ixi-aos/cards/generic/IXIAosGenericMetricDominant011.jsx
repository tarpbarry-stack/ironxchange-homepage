...
export default function IXIAosGenericMetricDominant011({
  ...
  return (
    <article className="ixi-card-011" data-card-number="011" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        .ixi-card-011,.ixi-card-011 *{box-sizing:border-box}.ixi-card-011{--y:#ffc400;--line:#383838;--soft:#292929;position:relative;width:298px;height:471px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#131313,#0a0a0a);color:#f4f4f4;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .c011-head{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}.c011-identity{max-width:188px}.c011-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c011-identity h2{margin:3px 0 0;color:#f8f8f8;font-size:13px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c011-identity small{display:block;margin-top:4px;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .c011-body{position:absolute;top:48px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.c011-primary{flex:0 0 88px;display:flex;flex-direction:column;align-items:center;justify-content:center;border:1px solid #5b5540;border-radius:6px;background:radial-gradient(circle at 50% 15%,rgba(255,196,0,.07),transparent 58%),linear-gradient(180deg,#181818,#111111);box-shadow:inset 0 1px #ffffff0b}.c011-primary span{color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em}.c011-primary strong{margin-top:5px;color:#fff;font-size:30px;font-weight:950;line-height:.95}.c011-primary small{margin-top:6px;color:#797979;font-size:4.7px;font-weight:900;letter-spacing:.06em}
        .c011-support-grid{flex:0 0 67px;display:grid;grid-template-columns:repeat(3,1fr);gap:4px}.c011-support{min-width:0;padding:8px 7px;border:1px solid var(--line);border-radius:5px;background:linear-gradient(180deg,#171717,#121212)}.c011-support span{display:block;color:#8f8f8f;font-size:4.8px;font-weight:950;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c011-support strong{display:block;margin-top:5px;color:#f2f2f2;font-size:12px;font-weight:950;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c011-support i{display:block;height:4px;margin-top:7px;overflow:hidden;border-radius:3px;background:#2c2c2c}.c011-support i b{display:block;height:100%;border-radius:3px;background:var(--y)}
        .c011-details{flex:1;min-height:0;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c011-relations{flex:0 0 82px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c011-title{height:19px;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.05em}.c011-scroll{height:calc(100% - 19px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f transparent}.c011-scroll::-webkit-scrollbar,.c011-editor main::-webkit-scrollbar{width:4px}.c011-scroll::-webkit-scrollbar-track,.c011-editor main::-webkit-scrollbar-track{background:transparent}.c011-scroll::-webkit-scrollbar-thumb,.c011-editor main::-webkit-scrollbar-thumb{border-radius:6px;background:#4f4f4f}.c011-row{height:23px;display:grid;grid-template-columns:42% 58%;align-items:center;padding:0 8px;border-bottom:1px solid #262626}.c011-row span{color:#888888;font-size:5.2px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c011-row strong{color:#eaeaea;font-size:6.8px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c011-relations button{width:100%;height:27px;display:flex;align-items:center;justify-content:space-between;padding:0 8px;border:0;border-bottom:1px solid #262626;background:transparent;color:#eaeaea;text-align:left}.c011-relations button span{min-width:0}.c011-relations small{display:block;color:#858585;font-size:4.5px;font-weight:900}.c011-relations strong{display:block;margin-top:2px;font-size:6.5px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c011-relations button>b{color:var(--y);font-size:10px}.c011-empty{height:100%;display:flex;align-items:center;justify-content:center;color:#5e5e5e;font-size:5px;font-weight:900}
        .c011-commands{position:absolute;left:7px;right:7px;bottom:23px;height:28px;display:grid;grid-template-columns:repeat(3,1fr);gap:4px;padding:3px 0}.c011-commands button{border:1px solid #303030;border-radius:4px;background:linear-gradient(180deg,#151515,#0f0f0f);color:#919191;font-size:7px;font-weight:900}.c011-commands button b{margin-left:3px;color:#dadada;font-size:5.5px;letter-spacing:.04em}
        .c011-editor{position:absolute;inset:0;z-index:200;background:#0d0d0d}.c011-editor>header{height:43px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #343434;background:#171717}.c011-editor>header small{display:block;color:var(--y);font-size:5px;font-weight:950}.c011-editor>header strong{display:block;margin-top:3px;font-size:10px}.c011-editor nav{display:flex;gap:4px}.c011-editor button{height:22px;padding:0 8px;border:1px solid #ffffff16;border-radius:4px;background:#131313;color:#dfdfdf;font-size:6px;font-weight:950}.c011-editor nav button:first-child{color:var(--y)}.c011-editor main{position:absolute;top:43px;left:0;right:0;bottom:0;padding:8px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f transparent}.c011-editor label{display:block;margin-bottom:6px;padding:7px;border:1px solid #2f2f2f;border-radius:5px;background:#121212}.c011-editor label span{display:block;margin-bottom:4px;color:#939393;font-size:5px;font-weight:900}.c011-editor input{width:100%;height:25px;padding:0 7px;border:1px solid #373737;border-radius:4px;background:#0b0b0b;color:#efefef;font-size:7px;font-weight:850;outline:none}
      `}</style>
    </article>
  );
}
