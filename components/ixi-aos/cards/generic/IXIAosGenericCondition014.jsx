...
export default function IXIAosGenericCondition014({
  ...
  return (
    <article className="ixi-card-014" data-card-number="014" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        .ixi-card-014,.ixi-card-014 *{box-sizing:border-box}.ixi-card-014{--y:#ffc400;--line:#383838;--soft:#292929;position:relative;width:${W}px;height:${H}px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:radial-gradient(circle at 82% 10%,#5f2d1718,transparent 28%),linear-gradient(180deg,#131313,#0a0a0a);color:#f4f4f4;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .c014-head{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}.c014-identity{max-width:188px}.c014-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c014-identity h2{margin:3px 0 0;color:#f8f8f8;font-size:13px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c014-identity small{display:block;margin-top:4px;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .c014-body{position:absolute;top:48px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.c014-state{flex:0 0 55px;display:grid;grid-template-columns:1.25fr 1fr;gap:5px}.c014-severity,.c014-status{display:flex;flex-direction:column;justify-content:center;padding:0 10px;border:1px solid var(--line);border-radius:5px;background:linear-gradient(180deg,#171717,#121212)}.c014-severity{border-color:#66593a}.c014-state span,.c014-context-grid span,.c014-extra-grid span{color:#919191;font-size:5px;font-weight:950;letter-spacing:.05em}.c014-severity span{color:var(--y)}.c014-state strong{margin-top:5px;overflow:hidden;font-size:13px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}.c014-severity strong{color:#fff1b3}
        .c014-condition{flex:0 0 61px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c014-title{height:19px;display:flex;align-items:center;justify-content:space-between;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.05em}.c014-title>b{display:grid;place-items:center;min-width:18px;height:12px;padding:0 4px;border:1px solid #ffffff10;border-radius:7px;background:#0d0d0d;color:#909090;font-size:5px}.c014-condition-copy{height:42px;display:flex;align-items:center;gap:9px;padding:0 9px}.c014-condition-copy>b{color:var(--y);font-size:11px}.c014-condition-copy>strong{min-width:0;overflow:hidden;color:#f0f0f0;font-size:8px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}
        .c014-context-grid{flex:0 0 78px;display:grid;grid-template-columns:1fr 1fr;gap:5px}.c014-context-grid>div,.c014-extra-grid>div{min-width:0;display:flex;flex-direction:column;justify-content:center;padding:0 8px;border:1px solid var(--line);border-radius:5px;background:#121212}.c014-context-grid strong,.c014-extra-grid strong{margin-top:4px;overflow:hidden;color:#eaeaea;font-size:6.5px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}
        .c014-current{flex:0 0 50px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c014-current-value{height:31px;display:flex;align-items:center;gap:7px;padding:0 8px}.c014-current-value span{color:var(--y);font-size:8px}.c014-current-value strong{min-width:0;overflow:hidden;color:#eaeaea;font-size:7px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}
        .c014-evidence{flex:0 0 73px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c014-evidence-body{height:54px;display:grid;grid-template-columns:72px 1fr;gap:5px;padding:5px}.c014-evidence-media{overflow:hidden;border:1px solid var(--soft);border-radius:4px;background:#0b0b0b}.c014-evidence-media img{width:100%;height:100%;display:block;object-fit:cover}.c014-evidence-media>div{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px}.c014-evidence-media>div b{color:#7a7a7a;font-size:12px}.c014-evidence-media>div small{color:#686868;font-size:4.3px;font-weight:900}.c014-extra-grid{display:grid;grid-template-columns:1fr 1fr;gap:4px;overflow:hidden}.c014-extra-grid>div{padding:0 6px}
        .c014-relations{min-height:0;flex:1;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c014-scroll{height:calc(100% - 19px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#535353 transparent}.c014-scroll::-webkit-scrollbar,.c014-editor main::-webkit-scrollbar{width:4px}.c014-scroll::-webkit-scrollbar-track,.c014-editor main::-webkit-scrollbar-track{background:transparent}.c014-scroll::-webkit-scrollbar-thumb,.c014-editor main::-webkit-scrollbar-thumb{border-radius:3px;background:#535353}.c014-scroll::-webkit-scrollbar-thumb:hover,.c014-editor main::-webkit-scrollbar-thumb:hover{background:#7b6a20}.c014-scroll button{width:100%;min-height:28px;display:grid;grid-template-columns:1fr auto;align-items:center;padding:4px 6px;border:0;border-bottom:1px solid var(--soft);background:transparent;color:#fff;text-align:left}.c014-scroll button span{min-width:0;display:flex;flex-direction:column}.c014-scroll button small{color:#838383;font-size:4.8px;font-weight:900}.c014-scroll button strong{margin-top:2px;overflow:hidden;font-size:6.5px;text-overflow:ellipsis;white-space:nowrap}.c014-scroll button>b{color:#7a7a7a}.c014-empty{padding:10px;color:#6a6a6a;font-size:5px;font-weight:900;text-align:center}
        .c014-commands{position:absolute;left:7px;right:7px;bottom:23px;height:25px;display:grid;grid-template-columns:repeat(3,1fr);gap:5px;z-index:20}.c014-commands button{border:1px solid #343434;border-radius:4px;background:#121212;color:#00c2ff;font-size:8px;font-weight:950}.c014-commands b{margin-left:3px;color:#aeaeae;font-size:5.5px}
        .c014-editor{position:absolute;inset:0;z-index:100;background:#0b0b0b}.c014-editor>header{height:43px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid var(--line);background:#161616}.c014-editor header small{display:block;color:var(--y);font-size:5px;font-weight:950}.c014-editor header strong{display:block;margin-top:3px;font-size:9px}.c014-editor nav{display:flex;gap:4px}.c014-editor nav button{height:22px;padding:0 8px;border:1px solid #4d4430;border-radius:4px;background:#131313;color:var(--y);font-size:5.5px;font-weight:950}.c014-editor main{position:absolute;top:43px;left:0;right:0;bottom:0;overflow-y:auto;padding:8px}.c014-editor main>label{display:block;margin-top:7px}.c014-editor label span{display:block;margin-bottom:4px;color:#929292;font-size:5px;font-weight:950}.c014-editor input{width:100%;height:28px;padding:0 7px;border:1px solid #383838;border-radius:4px;background:#111111;color:#f2f2f2;font-size:7px;font-weight:850;outline:none}.c014-editor input:focus{border-color:#806a1f}
      `}</style>
    </article>
  );
}
