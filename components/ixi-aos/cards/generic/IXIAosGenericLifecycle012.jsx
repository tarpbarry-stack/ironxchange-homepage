...
export default function IXIAosGenericLifecycle012({
  ...
  return (
    <article className="ixi-card-012" data-card-number="012" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        .ixi-card-012,.ixi-card-012 *{box-sizing:border-box}.ixi-card-012{--y:#ffc400;--line:#383838;--soft:#292929;position:relative;width:298px;height:471px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#131313,#0a0a0a);color:#f4f4f4;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .c012-head{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}.c012-identity{max-width:188px}.c012-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c012-identity h2{margin:3px 0 0;color:#f8f8f8;font-size:13px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c012-identity small{display:block;margin-top:4px;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .c012-body{position:absolute;top:48px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.c012-status{flex:0 0 58px;display:grid;grid-template-columns:1.45fr .75fr;gap:5px}.c012-status-copy,.c012-progress-copy{display:flex;flex-direction:column;justify-content:center;padding:0 10px;border:1px solid var(--line);border-radius:5px;background:linear-gradient(180deg,#171717,#121212)}.c012-status-copy{border-color:#5b5540}.c012-status span,.c012-stage span,.c012-dates span,.c012-detail-grid span{color:#919191;font-size:5px;font-weight:950;letter-spacing:.05em}.c012-status-copy>span{color:var(--y)}.c012-status strong{margin-top:5px;font-size:14px;font-weight:950}.c012-progress-copy strong{font-size:18px;color:var(--y)}
        .c012-progress-band{flex:0 0 58px;padding:11px 10px 7px;border:1px solid var(--line);border-radius:5px;background:#121212}.c012-progress-line{position:relative;height:6px;border-radius:4px;background:#2d2d2d;box-shadow:inset 0 1px 2px #0008}.c012-progress-line i{display:block;height:100%;border-radius:4px;background:linear-gradient(90deg,#b58b00,var(--y))}.c012-progress-line b{position:absolute;top:-3px;width:11px;height:11px;border:2px solid #191919;border-radius:50%;background:var(--y);box-shadow:0 0 0 1px #6f651e}.c012-dates{display:flex;justify-content:space-between;margin-top:10px}.c012-dates div:last-child{text-align:right}.c012-dates strong{display:block;margin-top:2px;color:#e7e7e7;font-size:6.5px}
        .c012-stage-grid{flex:0 0 54px;display:grid;grid-template-columns:1.25fr 1fr;gap:5px}.c012-stage{min-width:0;display:flex;flex-direction:column;justify-content:center;padding:0 9px;border:1px solid var(--line);border-radius:5px;background:#131313}.c012-stage.primary{background:linear-gradient(180deg,#181818,#121212)}.c012-stage strong{margin-top:5px;overflow:hidden;color:#f2f2f2;font-size:9px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}.c012-stage.primary strong{color:var(--y)}
        .c012-milestone{flex:0 0 58px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c012-title{height:19px;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.05em}.c012-milestone-value{height:39px;display:flex;align-items:center;gap:8px;padding:0 9px}.c012-milestone-value span{color:var(--y);font-size:10px}.c012-milestone-value strong{min-width:0;overflow:hidden;color:#eaeaea;font-size:8px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}
        .c012-detail-grid{flex:0 0 42px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:5px;overflow:hidden}.c012-detail-grid>div{min-width:0;display:flex;flex-direction:column;justify-content:center;padding:0 8px;border:1px solid var(--line);border-radius:5px;background:#121212}.c012-detail-grid strong{margin-top:3px;overflow:hidden;color:#e7e7e7;font-size:6.5px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}
        .c012-relations{min-height:0;flex:1;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c012-scroll{height:calc(100% - 19px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f transparent}.c012-scroll::-webkit-scrollbar,.c012-editor main::-webkit-scrollbar{width:4px}.c012-scroll::-webkit-scrollbar-track,.c012-editor main::-webkit-scrollbar-track{background:transparent}.c012-scroll::-webkit-scrollbar-thumb,.c012-editor main::-webkit-scrollbar-thumb{border-radius:6px;background:#4f4f4f}.c012-scroll button{width:100%;height:28px;display:flex;align-items:center;justify-content:space-between;padding:0 8px;border:0;border-bottom:1px solid #262626;background:transparent;color:#eaeaea;text-align:left}.c012-scroll button span{min-width:0}.c012-scroll small{display:block;color:#858585;font-size:4.5px;font-weight:900}.c012-scroll strong{display:block;margin-top:2px;font-size:6.5px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c012-scroll button>b{color:var(--y);font-size:10px}.c012-empty{height:100%;display:flex;align-items:center;justify-content:center;color:#5e5e5e;font-size:5px;font-weight:900}
        .c012-commands{position:absolute;left:7px;right:7px;bottom:23px;height:28px;display:grid;grid-template-columns:repeat(3,1fr);gap:4px;padding:3px 0}.c012-commands button{border:1px solid #303030;border-radius:4px;background:linear-gradient(180deg,#151515,#0f0f0f);color:#919191;font-size:7px;font-weight:900}.c012-commands button b{margin-left:3px;color:#dadada;font-size:5.5px;letter-spacing:.04em}
        .c012-editor{position:absolute;inset:0;z-index:200;background:#0d0d0d}.c012-editor>header{height:43px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #343434;background:#171717}.c012-editor>header small{display:block;color:var(--y);font-size:5px;font-weight:950}.c012-editor>header strong{display:block;margin-top:3px;font-size:10px}.c012-editor nav{display:flex;gap:4px}.c012-editor button{height:22px;padding:0 8px;border:1px solid #ffffff16;border-radius:4px;background:#131313;color:#dfdfdf;font-size:6px;font-weight:950}.c012-editor nav button:first-child{color:var(--y)}.c012-editor main{position:absolute;top:43px;left:0;right:0;bottom:0;padding:8px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f transparent}.c012-editor label{display:block;margin-bottom:6px;padding:7px;border:1px solid #2f2f2f;border-radius:5px;background:#121212}.c012-editor label span{display:block;margin-bottom:4px;color:#939393;font-size:5px;font-weight:900}.c012-editor input{width:100%;height:25px;padding:0 7px;border:1px solid #373737;border-radius:4px;background:#0b0b0b;color:#efefef;font-size:7px;font-weight:850;outline:none}
      `}</style>
    </article>
  );
}
