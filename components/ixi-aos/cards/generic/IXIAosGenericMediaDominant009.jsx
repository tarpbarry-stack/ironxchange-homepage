  ...
  return (
    <article className="ixi-card-009" data-card-number="009" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        ...
        .c009-editor-row.business-id{grid-template-columns:.85fr 1.25fr}.c009-editor-fixed-label{height:25px;display:flex;align-items:center;padding:0 7px;border:1px solid #333934;border-radius:4px;background:#111411;color:var(--y);font-size:7px;font-weight:950}
      `}</style>
    </article>
  );
}
