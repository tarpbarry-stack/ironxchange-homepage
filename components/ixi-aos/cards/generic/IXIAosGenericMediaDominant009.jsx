    ...
    <article className="ixi-card-009" data-card-number="009" data-card-skin={skinId}>
      ...
      <main className="c009-body">
        <section className="c009-media">
          ...
          {actions.canEdit ? (
            <button className="c009-photo-action" type="button" disabled={saving || Boolean(mediaStatus)} onClick={event => {
              event.preventDefault();
              event.stopPropagation();
              mediaInputRef.current?.click();
            }}>{mediaStatus || (image ? "CHANGE PHOTO" : "+ ADD PHOTO")}</button>
          ) : null}
          <input ref={mediaInputRef} className="c009-file-input" type="file" accept={IXI_AOS_MEDIA_ACCEPT} onChange={addPrimaryPhoto} />
          {mediaError ? <span className="c009-media-error" role="alert">{mediaError}</span> : null}
        </section>
      ...
      <style jsx global>{`
        ...
        .ixi-card-009{--y:#ffc400;--line:#393939;--soft:#292929;position:relative;width:${W}px;height:${H}px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#131313,#0a0a0a);color:#f4f4f4;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .c009-header{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}
        .c009-identity{max-width:188px}.c009-identity>span{display:block;overflow:hidden;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;text-overflow:ellipsis;white-space:nowrap}.c009-identity h2{margin:3px 0 0;overflow:hidden;color:#f8f8f8;font-size:13px;font-weight:950;line-height:1;text-overflow:ellipsis;white-space:nowrap}.c009-identity small{display:block;margin-top:4px;overflow:hidden;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;text-overflow:ellipsis;white-space:nowrap}
        ...
        .c009-media{position:relative;flex:0 0 172px;overflow:hidden;border:1px solid var(--line);border-radius:6px;background:#0c0c0c;box-shadow:inset 0 1px #ffffff0c}.c009-media img{width:100%;height:100%;display:block;object-fit:cover}.c009-media-empty{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;color:#6b6b6b;background:linear-gradient(135deg,#121212,#0b0b0b)}.c009-media-empty b{font-size:24px}.c009-media-empty span{font-size:5px;font-weight:900;letter-spacing:.08em}.c009-media-shade{position:absolute;inset:auto 0 0;height:52px;background:linear-gradient(180deg,transparent,#050706e8);pointer-events:none}.c009-media-id{position:absolute;left:8px;right:86px;bottom:7px;min-width:0}.c009-media-id span{display:block;color:#a8a8a8;font-size:5px;font-weight:900;letter-spacing:.05em}.c009-media-id strong{display:block;margin-top:2px;overflow:hidden;color:#fff;font-size:10px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}.c009-photo-action{position:absolute;right:7px;bottom:7px;height:21px;max-width:112px;overflow:hidden;padding:0 7px;border:1px solid #ffffff1a;border-radius:4px;background:#0b0e0cdd;color:var(--y);font-size:5.5px;font-weight:950;letter-spacing:.04em;text-overflow:ellipsis;white-space:nowrap}.c009-photo-action:disabled{cursor:wait;opacity:.65}.c009-file-input{display:none}.c009-media-error{position:absolute;left:7px;right:7px;top:7px;z-index:4;padding:4px 6px;border:1px solid #ff6b6b66;border-radius:4px;background:#160909e8;color:#ff8b8b;font-size:5px;font-weight:900}
        .c009-detail-strip{flex:0 0 39px;display:grid;grid-template-columns:minmax(0,1.7fr) minmax(0,.65fr) minmax(0,.8fr);gap:4px}.c009-detail{min-width:0;padding:6px 7px;border:1px solid #313131;border-radius:5px;background:#111111}.c009-detail span{display:block;overflow:hidden;color:#7e7e7e;font-size:4.5px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}.c009-detail strong{display:block;margin-top:3px;overflow:hidden;color:#dfdfdf;font-size:8px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}
        .c009-relations{min-height:0;flex:1;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c009-section-title{height:18px;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#161616;color:var(--y);font-size:5.5px;font-weight:950;letter-spacing:.05em}.c009-rel-scroll{height:calc(100% - 18px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,.24) transparent}.c009-rel-scroll::-webkit-scrollbar,.c009-editor-scroll::-webkit-scrollbar{width:3px}.c009-rel-scroll::-webkit-scrollbar-track,.c009-editor-scroll::-webkit-scrollbar-track{background:transparent}.c009-rel-scroll::-webkit-scrollbar-thumb,.c009-editor-scroll::-webkit-scrollbar-thumb{border-radius:999px;background:rgba(255,255,255,.22)}.c009-rel-scroll::-webkit-scrollbar-thumb:hover,.c009-editor-scroll::-webkit-scrollbar-thumb:hover{background:rgba(255,196,0,.48)}.c009-rel-scroll button{width:100%;height:26px;display:flex;align-items:center;justify-content:space-between;padding:0 7px;border:0;border-bottom:1px solid #262626;background:transparent;color:#eaeaea;text-align:left}.c009-rel-scroll button span{min-width:0}.c009-rel-scroll small{display:block;color:#858585;font-size:4.5px;font-weight:900}.c009-rel-scroll strong{display:block;margin-top:2px;overflow:hidden;font-size:6.5px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}.c009-rel-scroll button>b{color:var(--y);font-size:10px}.c009-empty{height:100%;display:flex;align-items:center;justify-content:center;color:#5e5e5e;font-size:5px;font-weight:900}
        .c009-commands{position:absolute;left:7px;right:7px;bottom:23px;height:28px;display:grid;grid-template-columns:repeat(3,1fr);gap:4px;padding:3px 0}.c009-commands button{border:1px solid #303030;border-radius:4px;background:linear-gradient(180deg,#151515,#0f0f0f);color:#919191;font-size:7px;font-weight:900}.c009-commands button b{margin-left:3px;color:#dadada;font-size:5.5px;letter-spacing:.04em}
        .c009-editor{position:absolute;inset:0;z-index:200;background:#0d0d0d;color:#f4f4f4}.c009-editor-head{height:43px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #343434;background:#171717}.c009-editor-head small{display:block;color:var(--y);font-size:5px;font-weight:950}.c009-editor-head strong{display:block;margin-top:3px;font-size:10px}.c009-editor-head nav{display:flex;gap:4px}.c009-editor-head button{height:22px;padding:0 8px;border:1px solid #ffffff16;border-radius:4px;background:#131313;color:#dfdfdf;font-size:6px;font-weight:950}.c009-editor-head nav button:first-child{color:var(--y)}.c009-editor-scroll{position:absolute;top:43px;left:0;right:0;bottom:0;padding:8px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,.24) transparent}.c009-editor-scroll section{margin-top:8px;padding:7px;border:1px solid #2f2f2f;border-radius:6px;background:#121212}.c009-editor-title{margin-bottom:6px;color:var(--y);font-size:5.5px;font-weight:950;letter-spacing:.06em}.c009-editor-scroll label{display:block}.c009-editor-scroll label span{display:block;margin-bottom:4px;color:#939393;font-size:5px;font-weight:900}.c009-editor-scroll input{width:100%;height:25px;padding:0 7px;border:1px solid #373737;border-radius:4px;background:#0b0b0b;color:#efefef;font-size:7px;font-weight:850;outline:none}.c009-editor-row{display:grid;grid-template-columns:.85fr 1.25fr 24px;gap:4px;margin-bottom:4px}.c009-editor-row.business-id{padding:3px;border:1px solid rgba(255,196,0,.20);border-radius:5px;background:rgba(255,196,0,.025)}.c009-editor-row button,.c009-add-field{border:1px solid #373737;border-radius:4px;background:#131313;color:#a2a2a2;font-weight:950}.c009-editor-row button{font-size:12px}.c009-editor-row button:disabled{color:var(--y);font-size:5px}.c009-add-field{width:100%;height:25px;color:var(--y);font-size:6px;letter-spacing:.05em}
        .c009-editor-row.business-id{grid-template-columns:.85fr 1.25fr}.c009-editor-fixed-label{height:25px;display:flex;align-items:center;padding:0 7px;border:1px solid #373737;border-radius:4px;background:#131313;color:var(--y);font-size:7px;font-weight:950}
      `}</style>
    </article>
  );
}
