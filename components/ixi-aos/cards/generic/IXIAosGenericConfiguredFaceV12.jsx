...
export default function IXIAosGenericConfiguredFaceV12({
  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        .ixi-generic-face-v12,.ixi-generic-face-v12 *{box-sizing:border-box}.ixi-generic-face-v12{--y:#ffc400;--line:#383838;--panel:#141414;position:relative;width:298px;height:471px;overflow:hidden;border:1px solid #4d4d4d;border-radius:13px;background:radial-gradient(circle at 82% 10%,#255d7420,transparent 27%),linear-gradient(180deg,#141414,#0a0a0a);color:#f3f3f3;font-family:"Inter Variable",Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}.gfv12-head{position:absolute;inset:0 0 auto;height:43px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#121212);z-index:20}.gfv12-ident{max-width:190px}.gfv12-ident span{display:block;color:var(--y);font-size:7px;font-weight:850;letter-spacing:.07em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gfv12-ident strong{display:block;margin-top:3px;font-size:14px;line-height:1.05;font-weight:850;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gfv12-scroll{position:absolute;top:43px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:6px;padding:6px 0;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#5e5e5e #0b0b0b}.gfv12-banner{flex:0 0 31px;display:flex;align-items:center;gap:9px;padding:0 9px;border:1px solid #404040;border-radius:5px;background:linear-gradient(180deg,#1a1a1a,#121212)}.gfv12-banner b{display:grid;place-items:center;width:23px;height:18px;border:1px solid #ffc40055;border-radius:3px;color:var(--y);font-size:8px}.gfv12-banner span{font-size:9px;font-weight:850;letter-spacing:.03em}.gfv12-section{flex:0 0 auto;overflow:hidden;border:1px solid var(--line);border-radius:6px;background:var(--panel)}.gfv12-section h3{height:23px;margin:0;display:flex;align-items:center;padding:0 8px;border-bottom:1px solid #2d2d2d;background:#181818;color:var(--y);font-size:8px;font-weight:850;letter-spacing:.05em}.gfv12-rows{display:flex;flex-direction:column}.gfv12-grid{display:grid;grid-template-columns:1fr 1fr}.gfv12-value{min-height:43px;display:flex;flex-direction:column;justify-content:center;padding:7px 8px;border-bottom:1px solid #282828}.gfv12-grid .gfv12-value{border-right:1px solid #282828}.gfv12-value small{color:#a0a0a0;font-size:7px;font-weight:750;letter-spacing:.025em}.gfv12-value strong{margin-top:3px;color:#f3f3f3;font-size:9px;font-weight:800;line-height:1.2;word-break:break-word}.gfv12-value em{margin-top:2px;color:#8c8c8c;font-size:7px;font-style:normal}.gfv12-relations{display:flex;flex-direction:column}.gfv12-relations button{min-height:43px;display:grid;grid-template-columns:1fr 18px;align-items:center;padding:6px 6px 6px 8px;border:0;border-bottom:1px solid #292929;background:transparent;color:#fff;text-align:left}.gfv12-relations button>span{min-width:0}.gfv12-relations small{display:block;color:#999999;font-size:7px;font-weight:750}.gfv12-relations strong{display:block;margin-top:2px;font-size:9px;font-weight:800;line-height:1.2;overflow-wrap:anywhere}.gfv12-relations em{display:block;margin-top:2px;color:#868686;font-size:7px;font-style:normal}.gfv12-relations button>b{color:var(--y);font-size:13px;text-align:center}.gfv12-empty{padding:14px;color:#888888;font-size:7px;font-weight:800;text-align:center}.gfv12-unconfigured{min-height:150px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:7px;border:1px dashed #3f3f3f;border-radius:6px;color:#959595;text-align:center}.gfv12-unconfigured>b{color:var(--y);font-size:16px}.gfv12-unconfigured strong{color:#cdcdcd;font-size:9px}.gfv12-unconfigured span{max-width:190px;font-size:7px;line-height:1.4}.gfv12-commands{position:absolute;left:7px;right:7px;bottom:20px;height:31px;display:grid;grid-template-columns:repeat(3,1fr);gap:5px;padding:3px 0;z-index:30}.gfv12-commands button{border:1px solid #343434;border-radius:4px;background:linear-gradient(180deg,#161616,#0f0f0f);color:#dcdcdc;font-family:inherit;font-size:9px;font-weight:800;cursor:pointer}.gfv12-commands button:hover,.gfv12-commands button:focus-visible{border-color:#75631b;color:var(--y);outline:none}.gfv12-commands b{margin-left:3px;font-size:7px;letter-spacing:.025em}.gfv12-editor{position:absolute;inset:0 0 16px;background:#0d0d0d;z-index:100}.gfv12-editor-head{height:43px;display:flex;align-items:center;justify-content:space-between;padding:7px 9px;border-bottom:1px solid #343434;background:#181818}.gfv12-editor-head small{display:block;color:#939393;font-size:7px;font-weight:750}.gfv12-editor-head strong{display:block;margin-top:3px;font-size:10px}.gfv12-editor-head nav{display:flex}.gfv12-editor-head button{height:24px;padding:0 8px;border:1px solid #404040;background:#121212;color:#e2e2e2;font-size:8px;font-weight:850}.gfv12-editor-head button:first-child{color:var(--y)}.gfv12-editor-scroll{position:absolute;top:43px;left:0;right:0;bottom:0;padding:9px;overflow-y:auto}.gfv12-editor-scroll label{display:block;margin-bottom:8px}.gfv12-editor-scroll label span{display:block;margin-bottom:4px;color:#999999;font-size:7px;font-weight:800}.gfv12-editor-scroll input{width:100%;height:30px;padding:0 8px;border:1px solid #3b3b3b;border-radius:4px;background:#141414;color:#fff;font-size:9px;font-weight:750;outline:none}.gfv12-editor-scroll input:focus{border-color:#ffc40077}
      `}</style>
    </article>
  );
}
