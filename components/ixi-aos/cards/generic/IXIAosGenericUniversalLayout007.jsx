...
function UniversalEditor({ object, saving, onCancel, onSave }) {
  ...
  useEffect(() => {
    ...
    nextDefinitions.forEach(definition => {
      nextDraft[definition.fieldId] = inputValue(
  ...
  async function save() {
    ...
    Object.keys(nextFields).forEach(fieldId => {
      if (fieldId.startsWith("field_") && !retainedIds.has(fieldId)) {
    ...
    <div className="u007-editor" onPointerDown={event => event.stopPropagation()}>
      ...
      <div className="u007-editor-scroll">
        ...
        <section>
          ...
          <div className="u007-editor-columns">
            <span>LABEL</span>
            <span>VALUE</span>
            <i />
          </div>
          ...
          <button className="u007-add-field" type="button" onClick={addField}>
            + ADD FIELD
          </button>
        </section>
      </div>
...
export default function IXIAosGenericUniversalLayout007({
  ...
  async function addPrimaryPhoto(event) {
    ...
    const existing = asArray(runtimeObject?.media);
    const nextObject = {
      ...runtimeObject,
      media: [photo, ...existing]
    };

    await save(nextObject);
    event.target.value = "";
  }
  ...
  return (
    <article
      className="ixi-universal-card-007"
    ...
    >
      ...
      <main className="u007-body">
        <section className="u007-media-shell">
          {image ? (
            ...
            <div className="u007-media-empty">
              <b>IXI</b>
              <span>IXI MEDIA</span>
            </div>
          )}

          <div className="u007-media-bar">
            <strong>IXI MEDIA</strong>
            {actions.canEdit ? (
              <button
                type="button"
                disabled={saving}
          ...
          <input
            ref={mediaInputRef}
            className="u007-media-input"
            type="file"
            accept="image/*"
            onChange={addPrimaryPhoto}
          />
        </section>
        ...
        <section className="u007-section u007-details">
          ...
          <div className="u007-section-scroll">
            ...
            {!populatedFields.length ? (
              <div className="u007-empty">NO DETAILS YET · EDIT TO ADD</div>
            ) : null}
          </div>
        </section>
        ...
        <section className="u007-section u007-relationships">
          ...
          <div className="u007-section-scroll">
            {relationships.map(relationship => (
              <button
                type="button"
                className="u007-relationship-row"
                key={relationship.id}
            ...
            {!relationships.length ? (
              <div className="u007-empty">NO RELATIONSHIPS</div>
            ) : null}
          </div>
        </section>
      </main>
      ...
      <style jsx global>{`
        ...
        .ixi-universal-card-007 * { box-sizing: border-box; }
        ...
        .ixi-universal-card-007 {
          ...
          border-radius:13px;
          background:linear-gradient(180deg,#101310,#080a09);
          color:#f4f5f4;
          font-family:Arial,Helvetica,sans-serif;
          box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008;
        }
        ...
        .u007-header {
          ...
          background:linear-gradient(180deg,#171a18,#101210);
          z-index:30;
        }

        .u007-identity { max-width:188px; }
        .u007-identity>span {
          display:block;
          overflow:hidden;
          color:var(--y);
        ...
        .u007-media-empty {
          ...
          gap:5px;
          background:linear-gradient(180deg,#111411,#0c0f0d);
        }
        .u007-media-empty b {
          color:#808782;
          font-size:21px;
        ...
        .u007-media-bar strong {
          color:#a2aaa4;
          font-size:5px;
          font-weight:950;
          letter-spacing:.12em;
        }
        .u007-media-bar button {
          height:17px;
          padding:0 6px;
          border:1px solid #5b501f;
          border-radius:3px;
          background:#171507;
          color:var(--y);
          font-size:5px;
        ...
        .u007-media-bar button:disabled { opacity:.45; cursor:wait; }
        .u007-media-input { display:none; }
        ...
        .u007-details { flex:1 1 106px; }
        .u007-relationships { flex:1 1 82px; }
        .u007-section-title {
          height:20px;
          display:flex;
          align-items:center;
        ...
        .u007-section-scroll::-webkit-scrollbar,
        .u007-editor-scroll::-webkit-scrollbar { width:5px; height:5px; }
        .u007-section-scroll::-webkit-scrollbar-track,
        .u007-editor-scroll::-webkit-scrollbar-track { background:#090b0a; }
        ...
        .u007-detail-row:nth-child(even),
        .u007-relationship-row:nth-child(even) { background:#ffffff08; }
        .u007-detail-row span {
          overflow:hidden;
          color:#929a95;
          font-size:5.5px;
          font-weight:900;
        ...
        .u007-relationship-row small {
          display:block;
          color:#8f9792;
          font-size:5px;
          font-weight:900;
        }
        .u007-relationship-row strong {
          display:block;
          margin-top:1px;
          font-size:7px;
          font-weight:900;
        }
        .u007-relationship-row em {
          display:block;
          color:#6e7771;
          font-size:5px;
          font-style:normal;
        }
        .u007-relationship-row>b {
          color:var(--y);
          font-size:10px;
          text-align:center;
        }
        ...
        .u007-commands button:last-child { border-right:0; }
        .u007-commands b { margin-left:3px; font-size:6px; }
        ...
        .u007-editor-head small {
          display:block;
          color:#8c958f;
          font-size:5px;
          font-weight:900;
        }
        .u007-editor-head strong {
          display:block;
          margin-top:3px;
          font-size:10px;
        }
        .u007-editor-head nav { display:flex; gap:3px; }
        .u007-editor-head button {
          height:24px;
          padding:0 8px;
        ...
        .u007-editor-head button:first-child { color:var(--y); }
        .u007-editor-scroll {
          position:absolute;
          top:43px;
          left:0;
        ...
        .u007-editor-scroll>.ixi-aos-primary-media-editor { margin-bottom:8px; }
        .u007-editor-scroll section {
          margin-bottom:9px;
          overflow:hidden;
        ...
        .u007-name-field { display:block; padding:7px; }
        .u007-name-field span {
          display:block;
          margin-bottom:4px;
          color:#929a95;
          font-size:5px;
        ...
        .u007-editor-row {
          display:grid;
          grid-template-columns:44% 1fr 20px;
          gap:4px;
          align-items:center;
          padding:0 6px;
        }
