  ...
  return (
    <article className="ixi-universal-card-007" data-card-number="007" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        ...
        .ixi-universal-card-007{--y:#ffc400;--line:#383838;--soft:#292929;position:relative;width:298px;height:471px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#121212,#0a0a0a);color:#f5f5f5;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .u007-header{position:absolute;inset:0 0 auto;height:43px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#191919,#111111);z-index:30}.u007-identity{max-width:188px}.u007-identity>span{display:block;overflow:hidden;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.07em;text-overflow:ellipsis;white-space:nowrap}.u007-identity h2{margin:4px 0 0;overflow:hidden;color:#f7f7f7;font-size:14px;font-weight:950;line-height:1;text-overflow:ellipsis;white-space:nowrap}
        .u007-body{position:absolute;top:43px;left:7px;right:7px;bottom:111px;display:flex;flex-direction:column;gap:5px;min-height:0;padding:5px 0;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f #0d0d0d}.u007-body::-webkit-scrollbar,.u007-section-scroll::-webkit-scrollbar,.u007-editor-scroll::-webkit-scrollbar{width:5px;height:5px}.u007-body::-webkit-scrollbar-track,.u007-section-scroll::-webkit-scrollbar-track,.u007-editor-scroll::-webkit-scrollbar-track{background:#0d0d0d}.u007-body::-webkit-scrollbar-thumb,.u007-section-scroll::-webkit-scrollbar-thumb,.u007-editor-scroll::-webkit-scrollbar-thumb{background:#4f4f4f;border:1px solid #1a1a1a;border-radius:999px}
        .u007-media-shell{position:relative;flex:0 0 112px;width:100%;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#0d0d0d}.u007-media-shell img{display:block;width:100%;height:100%;object-fit:cover;object-position:center;background:#0a0a0a}.u007-media-empty{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;background:#0f0f0f;color:#6f6f6f}.u007-media-empty b{color:#838383;font-size:21px;font-weight:950}.u007-media-empty span{color:#7a7a7a;font-size:5px;font-weight:900;letter-spacing:.08em}.u007-media-shade{position:absolute;inset:auto 0 0;height:52px;background:linear-gradient(180deg,transparent,#050706e8);pointer-events:none}.u007-media-id{position:absolute;left:8px;right:86px;bottom:7px;min-width:0;z-index:2}.u007-media-id span{display:block;color:#a8a8a8;font-size:5px;font-weight:900;letter-spacing:.05em}.u007-media-id strong{display:block;margin-top:2px;overflow:hidden;color:#fff;font-size:10px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}.u007-media-action{position:absolute;right:7px;bottom:7px;height:21px;max-width:112px;overflow:hidden;padding:0 8px;border:1px solid #ffc40066;border-radius:4px;background:#0d100ed9;color:var(--y);font-size:5.5px;font-weight:950;text-overflow:ellipsis;white-space:nowrap;z-index:2}.u007-media-action:disabled{cursor:wait;opacity:.65}.u007-media-input{display:none}.u007-media-error{position:absolute;left:7px;right:7px;top:7px;z-index:4;padding:4px 6px;border:1px solid #ff6b6b66;border-radius:4px;background:#160909e8;color:#ff8b8b;font-size:5px;font-weight:900}
        .u007-section{flex:0 0 112px;min-height:0;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#121212}.u007-relationships{flex-basis:104px}.u007-section-title{height:20px;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950}.u007-section-scroll{height:calc(100% - 20px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f #121212}.u007-detail-row{min-height:22px;display:grid;grid-template-columns:minmax(0,92px) 1fr;align-items:center;gap:7px;padding:4px 7px;border-bottom:1px solid #282828}.u007-detail-row:nth-child(even),.u007-relationship-row:nth-child(even){background:#ffffff08}.u007-detail-row span{overflow:hidden;color:#989898;font-size:5.5px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}.u007-detail-row strong{overflow:hidden;color:#f0f0f0;font-size:7.5px;font-weight:900;text-align:right;text-overflow:ellipsis;white-space:nowrap}
        .u007-relationship-row{width:100%;min-height:27px;display:grid;grid-template-columns:1fr 18px;align-items:center;padding:3px 6px 3px 8px;border:0;border-bottom:1px solid #282828;background:transparent;color:#fff;text-align:left}.u007-relationship-row small{display:block;color:#959595;font-size:5px;font-weight:900}.u007-relationship-row strong{display:block;margin-top:1px;font-size:7px;font-weight:900}.u007-relationship-row em{display:block;color:#757575;font-size:5px;font-style:normal}.u007-relationship-row>b{color:var(--y);font-size:10px;text-align:center}
        .u007-commands{position:absolute;left:7px;right:7px;bottom:78px;height:27px;display:grid;grid-template-columns:repeat(3,1fr);overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#111111;z-index:20}.u007-commands button{border:0;border-right:1px solid var(--soft);background:transparent;color:#bebebe;font-size:7px;font-weight:900}.u007-commands button:last-child{border-right:0}.u007-commands b{margin-left:3px;font-size:6px}.u007-child-rail{position:absolute;left:0;right:0;bottom:19px;height:55px;overflow:hidden;border-top:1px solid #2d2d2d;background:#0a0a0a;z-index:18}
        .u007-editor{position:absolute;inset:0 0 19px;background:#0b0b0b;z-index:220}.u007-editor-head{height:43px;display:flex;align-items:center;justify-content:space-between;padding:7px 9px;border-bottom:1px solid #343434;background:#181818}.u007-editor-head small{display:block;color:#939393;font-size:5px;font-weight:900}.u007-editor-head strong{display:block;margin-top:3px;font-size:10px}.u007-editor-head nav{display:flex;gap:3px}.u007-editor-head button{height:24px;padding:0 8px;border:1px solid #404040;border-radius:4px;background:#121212;color:#e2e2e2;font-size:6px;font-weight:900}.u007-editor-head button:first-child{color:var(--y)}.u007-editor-scroll{position:absolute;top:43px;left:0;right:0;bottom:0;padding:8px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f #0b0b0b}.u007-editor-scroll>.ixi-aos-primary-media-editor{margin-bottom:8px}.u007-editor-scroll section{margin-bottom:9px;overflow:hidden;border:1px solid #383838;border-radius:5px;background:#121212}.u007-editor-title{height:21px;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid #292929;color:var(--y);font-size:6px;font-weight:950}.u007-name-field{display:block;padding:7px}.u007-name-field span{display:block;margin-bottom:4px;color:#989898;font-size:5px;font-weight:900}.u007-name-field input{width:100%;height:29px;padding:0 7px;border:1px solid #3f3f3f;border-radius:4px;background:#0d0d0d;color:#fff;font-size:9px;font-weight:900}.u007-editor-columns,.u007-editor-row{display:grid;grid-template-columns:44% 1fr 20px;gap:4px;align-items:center;padding:0 6px}.u007-editor-columns{height:18px;color:#7d7d7d;font-size:5px;font-weight:900}.u007-editor-row{min-height:34px;border-top:1px solid #282828}.u007-editor-row input{width:100%;height:24px;padding:0 5px;border:1px solid #383838;border-radius:3px;background:#0d0d0d;color:#f3f3f3;font-size:7px;font-weight:850}.u007-editor-row button{width:20px;height:20px;border:1px solid #383838;border-radius:3px;background:#141414;color:#797979;font-size:12px}.u007-add-field{width:calc(100% - 12px);height:26px;margin:6px;border:1px solid #ffc40055;border-radius:4px;background:#ffc4000c;color:var(--y);font-size:6px;font-weight:950}
      `}</style>
    </article>
  );
}
