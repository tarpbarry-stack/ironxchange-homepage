  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        ...
        .u007-relationship-row:nth-child(even) {
          background: #ffffff08;
        }
        ...
        .u007-commands button:last-child {
          border-right: 0;
        }
        ...
        .u007-editor-head button:first-child {
          color: var(--y);
        }
        ...
        .u007-editor-scroll > .ixi-aos-primary-media-editor {
          margin-bottom: 8px;
        }
