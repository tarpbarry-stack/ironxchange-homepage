...
export default function IXIAosGenericDataDominant010({
  ...
  return (
    <article className="ixi-card-010" data-card-number="010" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        .ixi-card-010,.ixi-card-010 *{box-sizing:border-box}.ixi-card-010{--y:#ffc400;--line:#383838;--soft:#292929;position:relative;width:298px;height:471px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#131313,#0a0a0a);color:#f4f4f4;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        .c010-head{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}.c010-identity{max-width:188px}.c010-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c010-identity h2{margin:3px 0 0;color:#f8f8f8;font-size:13px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c010-identity small{display:block;margin-top:4px;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .c010-body{position:absolute;top:48px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.c010-hero-grid{flex:0 0 102px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));grid-template-rows:repeat(2,1fr);gap:4px}.c010-hero{min-width:0;display:flex;flex-direction:column;justify-content:center;padding:0 10px;border:1px solid var(--line);border-radius:5px;background:linear-gradient(180deg,#171717,#121212);box-shadow:inset 0 1px #ffffff08}.c010-hero.primary{border-color:#5b5540;background:linear-gradient(180deg,#191919,#121212)}.c010-hero span{color:#8f8f8f;font-size:5px;font-weight:950;letter-spacing:.05em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c010-hero.primary span{color:var(--y)}.c010-hero strong{margin-top:5px;color:#f2f2f2;font-size:12px;font-weight:950;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c010-hero.primary strong{font-size:15px}
        .c010-ledger{flex:1;min-height:0;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c010-relations{flex:0 0 90px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c010-title{height:19px;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.05em}.c010-scroll{height:calc(100% - 19px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f transparent}.c010-scroll::-webkit-scrollbar,.c010-editor main::-webkit-scrollbar{width:4px}.c010-scroll::-webkit-scrollbar-track,.c010-editor main::-webkit-scrollbar-track{background:transparent}.c010-scroll::-webkit-scrollbar-thumb,.c010-editor main::-webkit-scrollbar-thumb{border-radius:6px;background:#4f4f4f}.c010-row{height:24px;display:grid;grid-template-columns:minmax(0,42%) minmax(0,58%);align-items:center;padding:0 8px;border-bottom:1px solid #262626}.c010-row span{color:#888888;font-size:5.3px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c010-row strong{color:#eaeaea;font-size:7px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c010-relations button{width:100%;height:28px;display:flex;align-items:center;justify-content:space-between;padding:0 8px;border:0;border-bottom:1px solid #262626;background:transparent;color:#eaeaea;text-align:left}.c010-relations button span{min-width:0}.c010-relations small{display:block;color:#858585;font-size:4.5px;font-weight:900}.c010-relations strong{display:block;margin-top:2px;font-size:6.5px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c010-relations button>b{color:var(--y);font-size:10px}.c010-empty{height:100%;display:flex;align-items:center;justify-content:center;color:#5e5e5e;font-size:5px;font-weight:900}
        .c010-commands{position:absolute;left:7px;right:7px;bottom:23px;height:28px;display:grid;grid-template-columns:repeat(3,1fr);gap:4px;padding:3px 0}.c010-commands button{border:1px solid #303030;border-radius:4px;background:linear-gradient(180deg,#151515,#0f0f0f);color:#919191;font-size:7px;font-weight:900}.c010-commands button b{margin-left:3px;color:#dadada;font-size:5.5px;letter-spacing:.04em}
        .c010-editor{position:absolute;inset:0;z-index:200;background:#0d0d0d}.c010-editor>header{height:43px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #343434;background:#171717}.c010-editor>header small{display:block;color:var(--y);font-size:5px;font-weight:950}.c010-editor>header strong{display:block;margin-top:3px;font-size:10px}.c010-editor nav{display:flex;gap:4px}.c010-editor button{height:22px;padding:0 8px;border:1px solid #ffffff16;border-radius:4px;background:#131313;color:#dfdfdf;font-size:6px;font-weight:950}.c010-editor nav button:first-child{color:var(--y)}.c010-editor main{position:absolute;top:43px;left:0;right:0;bottom:0;padding:8px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f transparent}.c010-editor label{display:block;margin-bottom:6px;padding:7px;border:1px solid #2f2f2f;border-radius:5px;background:#121212}.c010-editor label span{display:block;margin-bottom:4px;color:#939393;font-size:5px;font-weight:900}.c010-editor input{width:100%;height:25px;padding:0 7px;border:1px solid #373737;border-radius:4px;background:#0b0b0b;color:#efefef;font-size:7px;font-weight:850;outline:none}
      `}</style>
    </article>
  );
}
