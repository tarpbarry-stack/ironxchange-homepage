  ...
  return (
    <article className="ixi-card-017" data-card-number="017" data-card-skin={skinId}>
      ...
      <style jsx global>{`
        ...
        .c017-head{position:absolute;inset:0 0 auto;height:48px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#1a1a1a,#111111);z-index:30}.c017-identity{max-width:188px}.c017-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c017-identity h2{margin:3px 0 0;color:#f8f8f8;font-size:13px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c017-identity small{display:block;margin-top:4px;color:#757575;font-size:4.8px;font-weight:900;letter-spacing:.06em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .c017-body{position:absolute;top:48px;left:7px;right:7px;bottom:51px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.c017-summary{flex:0 0 64px;display:grid;grid-template-columns:1fr 1fr;gap:5px}.c017-direct,.c017-descendants{display:flex;flex-direction:column;justify-content:center;padding:0 10px;border:1px solid var(--line);border-radius:5px;background:linear-gradient(180deg,#171717,#121212)}.c017-direct{border-color:#5b5540}.c017-summary span{color:#919191;font-size:5px;font-weight:950;letter-spacing:.055em}.c017-direct span{color:var(--y)}.c017-summary strong{margin-top:4px;font-size:21px;font-weight:950;line-height:1}.c017-descendants strong{color:#f0f0f0}.c017-descendants small{margin-top:4px;color:#686868;font-size:4.5px;font-weight:900;letter-spacing:.04em}
        .c017-structure{min-height:0;flex:1;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c017-title{height:21px;display:flex;align-items:center;justify-content:space-between;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818}.c017-title span{color:var(--y);font-size:6px;font-weight:950;letter-spacing:.05em}.c017-title>b{display:grid;place-items:center;min-width:20px;height:13px;padding:0 4px;border:1px solid #ffffff10;border-radius:7px;background:#0e0e0e;color:#8f8f8f;font-size:5px}.c017-structure-scroll{height:calc(100% - 21px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#535353 transparent}.c017-structure-scroll::-webkit-scrollbar,.c017-relation-scroll::-webkit-scrollbar,.c017-editor main::-webkit-scrollbar{width:4px}.c017-structure-scroll::-webkit-scrollbar-track,.c017-relation-scroll::-webkit-scrollbar-track,.c017-editor main::-webkit-scrollbar-track{background:transparent}.c017-structure-scroll::-webkit-scrollbar-thumb,.c017-relation-scroll::-webkit-scrollbar-thumb,.c017-editor main::-webkit-scrollbar-thumb{border-radius:3px;background:#535353}.c017-structure-scroll::-webkit-scrollbar-thumb:hover,.c017-relation-scroll::-webkit-scrollbar-thumb:hover,.c017-editor main::-webkit-scrollbar-thumb:hover{background:#7b6a20}
        .c017-child{width:100%;height:41px;display:grid;grid-template-columns:17px minmax(0,1fr) 43px;align-items:center;padding:0 6px;border:0;border-bottom:1px solid var(--soft);background:transparent;color:#f4f4f4;text-align:left;cursor:pointer}.c017-child:hover{background:#1a1a1a}.c017-node{color:#666666;font-size:12px;text-align:center}.c017-child-copy{min-width:0;display:flex;flex-direction:column}.c017-child-copy small{color:#7a7a7a;font-size:4.8px;font-weight:900;letter-spacing:.04em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.c017-child-copy strong{margin-top:3px;overflow:hidden;color:#f0f0f0;font-size:7.5px;font-weight:950;text-overflow:ellipsis;white-space:nowrap}.c017-child-count{height:28px;display:flex;flex-direction:column;align-items:flex-end;justify-content:center;padding-left:6px;border-left:1px solid #ffffff0d;color:var(--y);font-size:12px;font-weight:950}.c017-child-count>b{font-size:10px}.c017-child-count>small{margin-top:1px;color:#6f6f6f;font-size:4px;font-weight:900}.c017-empty{height:100%;min-height:92px;display:flex;flex-direction:column;align-items:center;justify-content:center;color:#686868}.c017-empty>b{color:#7a6b28;font-size:15px}.c017-empty>strong{margin-top:6px;color:#8f8f8f;font-size:8px}.c017-empty>span{margin-top:4px;font-size:5px;font-weight:900;letter-spacing:.05em}
        .c017-relations{flex:0 0 92px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#101010}.c017-relation-scroll{height:calc(100% - 21px);overflow-y:auto;scrollbar-width:thin;scrollbar-color:#535353 transparent}.c017-relation-scroll button{width:100%;min-height:31px;display:grid;grid-template-columns:1fr auto;align-items:center;padding:4px 7px;border:0;border-bottom:1px solid var(--soft);background:transparent;color:#fff;text-align:left}.c017-relation-scroll button>span{min-width:0;display:flex;flex-direction:column}.c017-relation-scroll small{color:#7a7a7a;font-size:4.8px;font-weight:900}.c017-relation-scroll strong{margin-top:2px;overflow:hidden;color:#e8e8e8;font-size:7px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}.c017-relation-scroll em{margin-top:1px;color:#757575;font-size:4.5px;font-style:normal}.c017-relation-scroll button>b{color:var(--y);font-size:10px}.c017-no-rel{height:100%;display:grid;place-items:center;color:#686868;font-size:5px;font-weight:900}
        .c017-commands{position:absolute;left:7px;right:7px;bottom:23px;height:25px;display:grid;grid-template-columns:repeat(3,1fr);gap:5px;z-index:20}.c017-commands button{border:1px solid #ffffff12;border-radius:4px;background:#121212;color:var(--cyan);font-size:8px;font-weight:950}.c017-commands b{margin-left:3px;color:#959595;font-size:5.5px}
        .c017-editor{position:absolute;inset:7px 7px 24px;z-index:100;overflow:hidden;border:1px solid #4e4e4e;border-radius:8px;background:#0c0c0c;box-shadow:0 18px 40px #000c}.c017-editor>header{height:42px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #343434;background:#181818}.c017-editor>header small{display:block;color:var(--y);font-size:5px;font-weight:950}.c017-editor>header strong{display:block;margin-top:3px;font-size:10px}.c017-editor nav{display:flex;gap:4px}.c017-editor nav button{height:22px;padding:0 7px;border:1px solid #4e4e4e;border-radius:4px;background:#101010;color:#e2e2e2;font-size:5px;font-weight:950}.c017-editor nav button:first-child{border-color:#ffc40055;color:var(--y)}.c017-editor main{height:calc(100% - 42px);overflow-y:auto;padding:8px;scrollbar-width:thin;scrollbar-color:#535353 transparent}.c017-editor label{display:block;margin-bottom:7px}.c017-editor label span{display:block;margin-bottom:3px;color:#868686;font-size:5px;font-weight:950}.c017-editor input{width:100%;height:26px;padding:0 7px;border:1px solid #383838;border-radius:4px;background:#131313;color:#f0f0f0;font-size:8px;font-weight:850;outline:none}.c017-editor input:focus{border-color:#ffc40088}
      `}</style>
    </article>
  );
}
