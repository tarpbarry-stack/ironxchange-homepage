  ...
  return (
    <article className={`ixi-location-f3-v12 mode-${mode}`}>
      ...
      <style jsx global>{`
        ...
        .ixi-location-f3-v12{--y:#ffc400;--line:#383838;--soft:#292929;--text:#f5f5f5;--muted:#9b9b9b;--lease:#a86cff;position:relative;width:${W}px;height:${H}px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#121212,#0a0a0a);color:var(--text);box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008;font-size:7px;line-height:1.15}
        .ixi-location-f3-v12 .f3-head{position:absolute;inset:0 0 auto;height:${HEADER}px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#191919,#111111);z-index:40}
        .ixi-location-f3-v12 .f3-identity{width:185px}.ixi-location-f3-v12 .f3-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ixi-location-f3-v12 .f3-identity>strong{display:block;margin-top:4px;color:#f7f7f7;font-size:14px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .ixi-location-f3-v12 .f3-save-actions{position:absolute;top:9px;right:8px;display:flex;height:20px}.ixi-location-f3-v12 .f3-save-actions button{height:20px;padding:0 7px;border:0;border-left:1px solid #ffffff0e;background:transparent;color:#e2e2e2;font-size:6px;font-weight:950;cursor:pointer}.ixi-location-f3-v12 .f3-save-actions button:first-child{color:var(--y)}
        .ixi-location-f3-v12 .f3-scroll{position:absolute;top:${HEADER}px;left:7px;right:7px;bottom:51px;padding:5px 0 8px;overflow-y:auto;overflow-x:hidden;scrollbar-width:thin;scrollbar-color:#434343 #0b0b0b}
        .ixi-location-f3-v12 .f3-scroll::-webkit-scrollbar{width:5px;height:5px}.ixi-location-f3-v12 .f3-scroll::-webkit-scrollbar-track{background:#0b0b0b}.ixi-location-f3-v12 .f3-scroll::-webkit-scrollbar-thumb{background:#434343;border:1px solid #181818;border-radius:999px}.ixi-location-f3-v12 .f3-scroll::-webkit-scrollbar-thumb:hover{background:#5c5c5c}.ixi-location-f3-v12 .f3-scroll::-webkit-scrollbar-corner{background:#0b0b0b}
        .ixi-location-f3-v12 .f3-section{margin:0 0 5px;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#121212}.ixi-location-f3-v12 .f3-section>h3{height:19px;margin:0;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.02em}.ixi-location-f3-v12 .f3-section.tone-lease>h3{color:var(--lease)}.ixi-location-f3-v12 .f3-section-body{background:#0f0f0f}
        .ixi-location-f3-v12 .f3-status-banner{min-height:58px;display:grid;grid-template-columns:1.12fr .88fr;align-items:center}.ixi-location-f3-v12 .f3-status-main{height:100%;display:grid;grid-template-columns:37px 1fr;align-items:center;padding:6px 8px;border-right:1px solid var(--soft)}.ixi-location-f3-v12 .f3-status-main>b{width:30px;height:30px;display:grid;place-items:center;border:1px solid #535353;border-radius:50%;color:#82ca19;font-size:17px}.ixi-location-f3-v12.mode-leased .f3-status-main>b{color:var(--lease)}.ixi-location-f3-v12 .f3-status-main strong{display:block;color:#82ca19;font-size:13px;font-weight:950}.ixi-location-f3-v12.mode-leased .f3-status-main strong{color:var(--lease)}.ixi-location-f3-v12 .f3-status-main small{display:block;margin-top:3px;color:#adadad;font-size:6px;font-weight:900}.ixi-location-f3-v12 .f3-status-date{padding:6px 8px}.ixi-location-f3-v12 .f3-status-date span{display:block;color:#a5a5a5;font-size:5px;font-weight:900}.ixi-location-f3-v12 .f3-status-date strong{display:block;margin-top:5px;font-size:8px}.ixi-location-f3-v12 input,.ixi-location-f3-v12 textarea{width:100%;min-width:0;border:1px solid #464646;border-radius:3px;background:#090909;color:#fff;outline:none;font-size:6px;font-weight:800}.ixi-location-f3-v12 input{height:19px;padding:0 4px}.ixi-location-f3-v12 textarea{min-height:50px;padding:5px;resize:vertical}.ixi-location-f3-v12 input:focus,.ixi-location-f3-v12 textarea:focus{border-color:var(--y)}
        .ixi-location-f3-v12 .f3-contact-grid{display:grid;grid-template-columns:1fr 1fr;gap:5px;margin-bottom:5px}.ixi-location-f3-v12 .f3-contact{min-height:82px;padding:7px;border:1px solid var(--line);border-radius:5px;background:#121212;overflow:hidden}.ixi-location-f3-v12 .f3-contact h4,.ixi-location-f3-v12 .f3-value-card h4,.ixi-location-f3-v12 .f3-lease-ytd h4{margin:0 0 7px;color:var(--y);font-size:6px;font-weight:950}.ixi-location-f3-v12.mode-leased .f3-contact h4,.ixi-location-f3-v12.mode-leased .f3-lease-ytd h4{color:var(--lease)}.ixi-location-f3-v12 .f3-contact>strong{display:block;font-size:7px;line-height:1.25}.ixi-location-f3-v12 .f3-contact>span,.ixi-location-f3-v12 .f3-contact>small{display:block;margin-top:4px;color:#c5c5c5;font-size:5.5px}.ixi-location-f3-v12 .f3-contact>b{display:block;margin-top:5px;color:#82ca19;font-size:6px}.ixi-location-f3-v12.mode-leased .f3-contact>b{color:var(--lease)}.ixi-location-f3-v12 .f3-contact-edit{display:grid;gap:3px}
        .ixi-location-f3-v12 .f3-split{display:grid;grid-template-columns:1.42fr .92fr;gap:5px;padding:5px}.ixi-location-f3-v12 .f3-list{min-width:0;border:1px solid var(--soft);border-radius:4px;overflow:hidden}.ixi-location-f3-v12 .f3-row{min-height:22px;display:grid;grid-template-columns:16px minmax(70px,.95fr) minmax(0,1fr) 16px;align-items:center;gap:3px;padding:2px 4px;border-bottom:1px solid var(--soft)}.ixi-location-f3-v12 .f3-row:last-child{border-bottom:0}.ixi-location-f3-v12 .f3-row-icon{color:#ababab;text-align:center;font-size:8px}.ixi-location-f3-v12 .f3-row-label{color:#ababab;font-size:5.5px;font-weight:850;line-height:1.1}.ixi-location-f3-v12 .f3-row strong{min-width:0;color:#f0f0f0;font-size:6px;font-weight:900;line-height:1.15;word-break:break-word}.ixi-location-f3-v12 .f3-row em{color:#7b7b7b;font-size:4.5px;font-style:normal;font-weight:950;text-align:center}
        .ixi-location-f3-v12 .f3-value-card{padding:7px;border:1px solid var(--line);border-radius:4px;background:#131313}.ixi-location-f3-v12 .f3-value-card p{margin:0;min-height:25px;display:flex;align-items:center;justify-content:space-between;gap:5px;border-bottom:1px solid var(--soft)}.ixi-location-f3-v12 .f3-value-card p:last-child{border-bottom:0}.ixi-location-f3-v12 .f3-value-card span{color:#ababab;font-size:5px}.ixi-location-f3-v12 .f3-value-card strong{font-size:6px;text-align:right}.ixi-location-f3-v12 .f3-value-card hr{border:0;border-top:1px solid #3f3f3f}.ixi-location-f3-v12 .f3-value-card .hero{display:block;padding:5px 0}.ixi-location-f3-v12 .f3-value-card .hero span,.ixi-location-f3-v12 .f3-value-card .hero strong{display:block}.ixi-location-f3-v12 .f3-value-card .hero strong{margin-top:4px;color:#82ca19;font-size:11px;text-align:left}.ixi-location-f3-v12 .lease-card h4{color:var(--lease)}
        ...
        .ixi-location-f3-v12 .f3-summary-grid{display:grid;gap:5px;padding:5px}.ixi-location-f3-v12 .f3-summary-grid.three{grid-template-columns:repeat(3,1fr)}.ixi-location-f3-v12 .f3-summary-grid.two{grid-template-columns:repeat(2,1fr)}.ixi-location-f3-v12 .f3-summary{min-height:52px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:5px;border:1px solid var(--line);border-radius:4px;background:#131313;text-align:center}.ixi-location-f3-v12 .f3-summary span{color:#ababab;font-size:5px;font-weight:850}.ixi-location-f3-v12 .f3-summary strong{font-size:10px}.ixi-location-f3-v12 .f3-summary small{color:#666666;font-size:4px;font-weight:950}.ixi-location-f3-v12 .f3-summary.tone-positive strong{color:#82ca19}.ixi-location-f3-v12 .f3-summary.tone-negative strong{color:#ff5c4f}.ixi-location-f3-v12 .f3-summary.tone-lease strong{color:var(--lease)}
        ...
        .ixi-location-f3-v12 .f3-lease-ytd{padding:7px;border:1px solid var(--line);border-radius:4px;background:#131313}.ixi-location-f3-v12 .f3-lease-ytd>.f3-summary{margin:0 5px 5px}
        .ixi-location-f3-v12 .f3-notes{padding:7px}.ixi-location-f3-v12 .f3-notes strong{display:block;min-height:38px;color:#d8d8d8;font-size:6px;line-height:1.45}
        .ixi-location-f3-v12 .f3-relationship-list{display:flex;flex-direction:column}.ixi-location-f3-v12 .f3-relationship{width:100%;min-height:23px;display:grid;grid-template-columns:17px minmax(72px,.75fr) minmax(0,1fr) 10px;align-items:center;gap:4px;padding:2px 5px;border:0;border-bottom:1px solid var(--soft);background:transparent;color:#efefef;text-align:left;cursor:pointer}.ixi-location-f3-v12 .f3-relationship:last-child{border-bottom:0}.ixi-location-f3-v12 .f3-relationship>span{color:#a5a5a5;text-align:center}.ixi-location-f3-v12 .f3-relationship>b{color:#ababab;font-size:5.5px}.ixi-location-f3-v12 .f3-relationship>strong{overflow:hidden;font-size:6px;text-overflow:ellipsis;white-space:nowrap}.ixi-location-f3-v12 .f3-relationship>i{color:#62c8ff;font-size:12px;font-style:normal}
        .ixi-location-f3-v12 .f3-commands{position:absolute;left:7px;right:7px;bottom:19px;height:27px;display:grid;grid-template-columns:repeat(3,1fr);gap:4px;padding-top:4px;border-top:1px solid #2c2c2c;background:#0b0b0b;z-index:35}.ixi-location-f3-v12 .f3-commands button{border:1px solid #383838;border-radius:4px;background:#121212;color:#e7e7e7;font-size:6px;font-weight:950;cursor:pointer}.ixi-location-f3-v12 .f3-commands button:hover{border-color:#606060;color:var(--y)}.ixi-location-f3-v12 .f3-commands span{margin-left:3px}
      `}</style>
    </article>
  );
}
