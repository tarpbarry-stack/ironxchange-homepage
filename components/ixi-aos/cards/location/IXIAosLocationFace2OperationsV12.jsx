  ...
  return (
    <article className={`ixi-aos-location-f2 skin-${skinId}`}>
      ...
      <style jsx global>{`
        ...
        .ixi-aos-location-f2{--y:#ffc400;--line:#383838;--soft:#292929;--surface:#121212;--surface2:#0d0d0d;--text:#f5f5f5;--muted:#9b9b9b;position:relative;width:${W}px;height:${H}px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#121212,#0a0a0a);color:var(--text);font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}
        ...
        .ixi-aos-location-f2 .ops-header{position:absolute;inset:0 0 auto;height:${HEADER}px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#191919,#111111);z-index:40}
        .ixi-aos-location-f2 .ops-identity{width:185px;min-width:0}.ixi-aos-location-f2 .ops-identity>span{display:block;overflow:hidden;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;text-overflow:ellipsis;white-space:nowrap}.ixi-aos-location-f2 .ops-identity>strong{display:block;margin-top:4px;overflow:hidden;color:#f7f7f7;font-size:14px;font-weight:950;line-height:1;text-overflow:ellipsis;white-space:nowrap}
        ...
        .ixi-aos-location-f2 .ops-scroll{position:absolute;top:${HEADER}px;bottom:${COMMANDS + RAIL}px;left:7px;right:7px;display:flex;flex-direction:column;gap:5px;padding:5px 0 8px;overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain;scrollbar-width:thin;scrollbar-color:#434343 #0b0b0b}
        .ixi-aos-location-f2 .ops-scroll::-webkit-scrollbar{width:5px}.ixi-aos-location-f2 .ops-scroll::-webkit-scrollbar-track{background:#0b0b0b}.ixi-aos-location-f2 .ops-scroll::-webkit-scrollbar-thumb{border:1px solid #181818;border-radius:999px;background:#434343}.ixi-aos-location-f2 .ops-scroll::-webkit-scrollbar-thumb:hover{background:#5c5c5c}.ixi-aos-location-f2 .ops-scroll::-webkit-scrollbar-corner{background:#0b0b0b}

        .ixi-aos-location-f2 .gate-code{flex:0 0 43px;display:grid;grid-template-columns:25px minmax(0,1fr) 34px;align-items:center;margin:0;padding:0 5px;border:1px solid var(--line);border-radius:5px;background:var(--surface)}.ixi-aos-location-f2 .gate-mark{display:grid;place-items:center;width:20px;height:27px;border-right:1px solid var(--soft);color:var(--y);font-size:12px}.ixi-aos-location-f2 .gate-copy{min-width:0;padding-left:7px}.ixi-aos-location-f2 .gate-copy span{display:block;color:var(--muted);font-size:5px;font-weight:900;letter-spacing:.05em}.ixi-aos-location-f2 .gate-copy strong{display:block;margin-top:3px;color:#f5f5f5;font-size:12px;font-weight:950;letter-spacing:.04em}.ixi-aos-location-f2 .gate-copy input{width:100%;height:18px;margin-top:2px}
