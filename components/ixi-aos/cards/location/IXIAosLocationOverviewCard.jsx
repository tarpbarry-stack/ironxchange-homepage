...
export default function IXIAosLocationOverviewCard({
  ...
  return (
    <article className={`ixi-generic-overview gov-${variant}`} data-card-number={variant} data-editing={editing ? "true" : "false"}>
      ...
      <style jsx global>{`
        .ixi-generic-overview,.ixi-generic-overview *{box-sizing:border-box}.ixi-generic-overview{--y:#ffc400;--line:#383838;--soft:#292929;position:relative;width:${W}px;height:${H}px;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#121212,#0a0a0a);color:#f5f5f5;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}.gov-head{position:absolute;inset:0 0 auto;height:43px;padding:7px 10px;border-bottom:1px solid #343434;background:linear-gradient(180deg,#191919,#111111);z-index:40}.gov-identity{width:185px}.gov-identity>span{display:block;color:var(--y);font-size:6px;font-weight:950;letter-spacing:.08em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.gov-identity>strong{display:block;margin-top:4px;color:#f7f7f7;font-size:14px;font-weight:950;line-height:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.gov-name-inline-editor{display:block;width:172px;height:18px;margin-top:2px;padding:0 5px;border:1px solid #404040;border-radius:3px;background:#141414;color:#f7f7f7;font-size:11px;font-weight:800;line-height:16px;outline:none}.gov-name-inline-editor:focus{border-color:#ffc40088}.gov-inline-edit-actions{position:absolute;top:8px;right:8px;z-index:260;display:flex;gap:3px}.gov-inline-edit-actions button{height:24px;padding:0 7px;border:1px solid #404040;border-radius:4px;background:#121212;color:#e2e2e2;font-size:6px;font-weight:950}.gov-inline-edit-actions button:first-child{color:var(--y);border-color:#ffc40055}.gov-inline-edit-actions button:disabled{opacity:.55}.gov-body{position:absolute;top:43px;left:7px;right:7px;display:flex;flex-direction:column;gap:5px;padding:5px 0;overflow:hidden}.gov-001 .gov-body,.gov-003 .gov-body{bottom:108px}.gov-002 .gov-body{bottom:51px}.gov-media{height:100%;min-height:0;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#0d0d0d}.gov-001>.gov-body>.gov-media{flex:0 0 112px}.gov-media img{width:100%;height:100%;display:block;object-fit:cover}.gov-media-empty{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;color:#6f6f6f;background:#0f0f0f}.gov-media-empty b{color:#838383;font-size:21px}.gov-media-empty span{font-size:5px;font-weight:900}.gov-media-inline-editor{width:100%;height:100%;padding:4px;overflow:hidden}.gov-media-inline-editor>.ixi-aos-primary-media-editor{width:100%;height:100%;min-height:0;padding:5px;grid-template-columns:72px 1fr;gap:6px}.gov-media-inline-editor .ixi-aos-primary-media-preview{width:72px;height:100%;min-height:56px}.gov-media-inline-editor .ixi-aos-primary-media-copy>div{margin-top:5px}.gov-003 .gov-media-inline-editor{padding:2px}.gov-003 .gov-media-inline-editor>.ixi-aos-primary-media-editor{padding:3px;grid-template-columns:46px 1fr;gap:3px}.gov-003 .gov-media-inline-editor .ixi-aos-primary-media-preview{width:46px;height:54px;min-height:0}.gov-003 .gov-media-inline-editor .ixi-aos-primary-media-copy>small{display:none}.gov-003 .gov-media-inline-editor .ixi-aos-primary-media-copy>div{margin-top:3px;gap:2px}.gov-003 .gov-media-inline-editor .ixi-aos-primary-media-copy label,.gov-003 .gov-media-inline-editor .ixi-aos-primary-media-copy button{height:18px;padding:0 3px;font-size:4.5px}.gov-descriptor{flex:0 0 43px;display:grid;grid-template-columns:20px 1fr;align-items:center;padding:0 8px;border:1px solid var(--line);border-radius:5px;background:#131313}.gov-002 .gov-descriptor{flex-basis:57px}.gov-mark{color:var(--y);font-size:12px;text-align:center}.gov-descriptor strong{display:block;color:#f0f0f0;font-size:8px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.gov-descriptor small{display:block;margin-top:3px;color:#9b9b9b;font-size:6px;font-weight:800;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.gov-descriptor-inline-editor{min-width:0;display:flex;flex-direction:column;gap:2px;overflow:hidden}.gov-descriptor-inline-editor input{width:100%;height:13px;min-height:13px;padding:0 4px;border:1px solid #3b3b3b;border-radius:2px;background:#0f0f0f;color:#f0f0f0;font-size:6px;font-weight:800;line-height:11px;outline:none}.gov-descriptor-inline-editor input:focus{border-color:#ffc40088}.gov-descriptor-inline-editor small{margin:0;font-size:5px}.gov-003-split{flex:0 0 82px;display:grid;grid-template-columns:1fr 1fr;gap:5px}.gov-003-info{min-width:0;display:flex;flex-direction:column;gap:5px}.gov-003-info .gov-descriptor{flex:1}.gov-003-secondary{flex:0 0 22px;display:flex;align-items:center;padding:0 7px;border:1px solid var(--line);border-radius:5px;background:#121212;color:#969696;font-size:5.5px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.gov-preview{flex:0 0 22px;display:grid;grid-template-columns:minmax(0,1fr) 34px 52px;align-items:center;border:1px solid var(--line);border-radius:5px;background:#121212;overflow:hidden}.gov-preview strong{padding:0 8px;overflow:hidden;color:#eaeaea;font-size:7px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}.gov-preview span{color:#838383;font-size:6px;text-align:center}.gov-preview button{height:100%;border:0;border-left:1px solid var(--soft);background:transparent;color:var(--y);font-size:7px;font-weight:950}.gov-preview button:disabled{color:#5e5e5e}.gov-metrics{flex:0 0 43px;display:grid;grid-template-columns:1fr 1.25fr 1fr;gap:4px}.gov-metric{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;border:1px solid var(--line);border-radius:5px;background:#131313}.gov-metric span{max-width:100%;padding:0 3px;overflow:hidden;color:#9b9b9b;font-size:5px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}.gov-metric strong{font-size:12px;font-weight:950}.gov-relations{min-height:0;flex:1;overflow:hidden;border:1px solid var(--line);border-radius:5px;background:#121212}.gov-relations h3{height:19px;margin:0;display:flex;align-items:center;padding:0 7px;border-bottom:1px solid var(--soft);background:#181818;color:var(--y);font-size:6px;font-weight:950}.gov-relation-scroll,.gov-field-editor-scroll{height:calc(100% - 19px);overflow-y:auto}.gov-relation-scroll button{width:100%;min-height:24px;display:grid;grid-template-columns:1fr 18px;align-items:center;padding:3px 6px 3px 8px;border:0;border-bottom:1px solid #282828;background:transparent;color:#fff;text-align:left}.gov-relation-scroll button:nth-child(even){background:#ffffff08}.gov-relation-scroll small{display:block;color:#959595;font-size:5px;font-weight:900}.gov-relation-scroll strong{display:block;margin-top:1px;font-size:7px;font-weight:900}.gov-relation-scroll em{display:block;color:#757575;font-size:5px;font-style:normal}.gov-relation-scroll button>b{color:var(--y);text-align:center}.gov-field-editor-scroll{padding:4px}.gov-field-editor-scroll label{display:grid;grid-template-columns:74px minmax(0,1fr);align-items:center;gap:4px;min-height:25px;padding:3px 4px;border-bottom:1px solid #282828}.gov-field-editor-scroll label:nth-child(even){background:#ffffff06}.gov-field-editor-scroll label span{overflow:hidden;color:#b3b3b3;font-size:6px;font-weight:900;text-overflow:ellipsis;white-space:nowrap}.gov-field-editor-scroll input{width:100%;min-width:0;height:20px;padding:0 5px;border:1px solid #3b3b3b;border-radius:3px;background:#141414;color:#fff;font-size:7px;font-weight:800;outline:none}.gov-field-editor-scroll input:focus{border-color:#ffc40088}.gov-empty{padding:15px;color:#6f6f6f;font-size:5.5px;font-weight:900;text-align:center}.gov-commands{position:absolute;left:7px;right:7px;height:27px;display:grid;grid-template-columns:repeat(3,1fr);border:1px solid var(--line);border-radius:5px;background:#111111;overflow:hidden;z-index:20}.gov-001 .gov-commands,.gov-003 .gov-commands{bottom:78px}.gov-002 .gov-commands{bottom:20px}.gov-commands button{border:0;border-right:1px solid var(--soft);background:transparent;color:#bebebe;font-size:7px;font-weight:900}.gov-commands button:last-child{border-right:0}.gov-commands button:disabled{color:#5e5e5e}.gov-commands span{margin-left:3px}.gov-thumbs{position:absolute;left:0;right:0;bottom:19px;height:55px;overflow:hidden;border-top:1px solid #2d2d2d;background:#0a0a0a;z-index:18}
      `}</style>
    </article>
  );
}
