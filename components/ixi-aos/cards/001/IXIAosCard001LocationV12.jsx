  ...
  return (
    <div className="card001 card board-color-none board-outline-1">
      ...
      <style jsx>{`
        ...
        .actions button{height:19px;min-width:77px;padding:0 7px;border:1px solid rgba(255,255,255,.07);border-radius:4px;background:rgba(255,255,255,.018);color:var(--ix-yellow,#ffc400);font-size:8px;font-weight:950;cursor:pointer}.actions span{margin-left:3px;color:rgba(255,255,255,.62);font-size:6px;font-weight:950}
