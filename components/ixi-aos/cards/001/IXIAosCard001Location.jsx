          ...
          {({ object }) => {
            ...
            return (
              <div className="aos-card001-v12-identity-shell ixi-v12-readable-card">
                <IXIAosLocationOverviewCard {...contractProps} object={face1EditObject} onSaveObject={handleFace1Save} variant="001" />

                {ixiIdentity ? <span className="aos-card001-ixi-identity" title={ixiIdentity}>{ixiIdentity}</span> : null}
