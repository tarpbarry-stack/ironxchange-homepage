import { clean, getFieldDefinitions, getObjectFields } from "../IXIAosSemanticObjectPresentation";
...
export function restoreFace1GenericSave(originalObject = {}, nextObject = {}, { allowAddedDefinitions = false, allowDefinitionEdits = false } = {}) {
  ...
  const originalDefinitions = getFieldDefinitions(originalObject);
  const editedDefinitions = getFieldDefinitions(nextObject);
