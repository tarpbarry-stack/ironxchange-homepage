  ...
  return (
    <div className={`ixi-aos-header-identity-shell ${className}`.trim()}>
      ...
      <style jsx>{`
        ...
        .ixi-aos-header-ixi-number{position:absolute;top:7px;right:9px;z-index:190;color:#8a8a8a;font-family:inherit;font-size:7px;font-weight:850;line-height:1;letter-spacing:.06em;white-space:nowrap;pointer-events:none}
