...
export default function IXIAosPrimaryMediaEditor({
  ...
  return (
    <section className="ixi-aos-primary-media-editor">
      ...
      <style jsx global>{`
        .ixi-aos-primary-media-editor,.ixi-aos-primary-media-editor *{box-sizing:border-box}.ixi-aos-primary-media-editor{display:grid;grid-template-columns:82px 1fr;gap:8px;min-height:72px;padding:7px;border:1px solid #383838;border-radius:5px;background:#121212}.ixi-aos-primary-media-preview{width:82px;height:62px;display:grid;place-items:center;overflow:hidden;border:1px solid #3a3a3a;border-radius:4px;background:#0b0b0b}.ixi-aos-primary-media-preview img{display:block;width:100%;height:100%;object-fit:contain;background:#0b0b0b}.ixi-aos-primary-media-preview>div{display:flex;flex-direction:column;align-items:center;gap:4px;color:#6f6f6f}.ixi-aos-primary-media-preview b{color:#ffc400;font-size:10px}.ixi-aos-primary-media-preview span{font-size:5px;font-weight:900}.ixi-aos-primary-media-copy{min-width:0;display:flex;flex-direction:column;justify-content:center}.ixi-aos-primary-media-copy>strong{color:#ffc400;font-size:6px;font-weight:950}.ixi-aos-primary-media-copy>small{margin-top:3px;color:#868686;font-size:5px;font-weight:850}.ixi-aos-primary-media-copy>div{display:flex;gap:4px;margin-top:8px}.ixi-aos-primary-media-copy label,.ixi-aos-primary-media-copy button{height:23px;display:flex;align-items:center;justify-content:center;padding:0 7px;border:1px solid #404040;border-radius:4px;background:#141414;color:#e2e2e2;font-size:5.5px;font-weight:950;cursor:pointer}.ixi-aos-primary-media-copy label{color:#ffc400;border-color:#ffc40055}.ixi-aos-primary-media-copy label[aria-disabled="true"],.ixi-aos-primary-media-copy button:disabled{cursor:wait;opacity:.45}.ixi-aos-primary-media-copy input{display:none}.ixi-aos-primary-media-copy>em{display:block;margin-top:4px;overflow:hidden;color:#6f6f6f;font-size:4.5px;font-style:normal;font-weight:850;text-overflow:ellipsis;white-space:nowrap}.ixi-aos-primary-media-copy>em.status{color:#00c2ff}.ixi-aos-primary-media-copy>em.error{color:#ff6b6b;white-space:normal}
      `}</style>
    </section>
  );
}
