  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        ...
        /* Face 3 keeps the same financial layout; these four choices restore the IXI/V12 surface family. */
        ...
        .f3-financial:has(.ixi-aos-card-header-controls.skin-industrial) .face-banner {
          clip-path:none !important;border-radius:4px !important;background:rgba(255,255,255,.02) !important;color:var(--accent) !important;
        }
      `}</style>
    </div>
  );
