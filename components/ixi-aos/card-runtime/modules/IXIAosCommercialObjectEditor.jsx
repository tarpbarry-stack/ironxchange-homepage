...
export default function IXIAosCommercialObjectEditor({
  ...
  return (
    <div className="ixi-aos-commercial-editor" onPointerDown={event => event.stopPropagation()}>
      ...
      <style jsx global>{`
        .ixi-aos-commercial-editor,.ixi-aos-commercial-editor *{box-sizing:border-box}.ixi-aos-commercial-editor{position:absolute;inset:0;z-index:260;overflow:hidden;border:1px solid #494949;border-radius:13px;background:linear-gradient(180deg,#121212,#0a0a0a);color:#f0f0f0;font-family:Arial,Helvetica,sans-serif;box-shadow:inset 0 1px #ffffff12,0 18px 40px #0008}.ixi-aos-commercial-editor>header{height:43px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border-bottom:1px solid #343434;background:#171717}.ixi-aos-commercial-editor>header small{display:block;color:#ffc400;font-size:5px;font-weight:950}.ixi-aos-commercial-editor>header strong{display:block;margin-top:3px;font-size:10px}.ixi-aos-commercial-editor>header nav{display:flex;gap:4px}.ixi-aos-commercial-editor button,.ixi-aos-commercial-editor select{height:24px;border:1px solid #3e3e3e;border-radius:4px;background:#131313;color:#dfdfdf;font-size:6px;font-weight:950}.ixi-aos-commercial-editor>header button{padding:0 9px}.ixi-aos-commercial-editor>header button:first-child{border-color:#ffc40066;color:#ffc400}.ixi-aos-commercial-editor button:disabled,.ixi-aos-commercial-editor select:disabled{opacity:.42;cursor:not-allowed}.ixi-aos-commercial-editor>main{position:absolute;top:43px;left:0;right:0;bottom:0;padding:8px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:#4f4f4f transparent}.ixi-aos-commercial-editor .editor-notice{display:flex;flex-direction:column;gap:3px;padding:7px;border:1px solid #a73a3a;border-radius:5px;background:#2a1111;color:#f5d7d7}.ixi-aos-commercial-editor .editor-notice.conflict{border-color:#ffc40066;background:#ffc4000d;color:#ffe89a}.ixi-aos-commercial-editor .editor-notice strong{font-size:6px;letter-spacing:.05em}.ixi-aos-commercial-editor .editor-notice span{font-size:6px;line-height:1.35}.ixi-aos-commercial-editor .editor-notice button{width:100%;margin-top:3px;border-color:#ffc40066;color:#ffc400}.ixi-aos-commercial-editor section{margin-top:8px}.ixi-aos-commercial-editor h4{height:20px;margin:0;display:flex;align-items:center;color:#ffc400;font-size:6px;font-weight:950;letter-spacing:.06em}.ixi-aos-commercial-editor .identity-field{display:block;padding:7px;border:1px solid #2f2f2f;border-radius:5px;background:#121212}.ixi-aos-commercial-editor label>span{display:block;margin-bottom:4px;color:#939393;font-size:5px;font-weight:900}.ixi-aos-commercial-editor input{width:100%;height:26px;padding:0 7px;border:1px solid #383838;border-radius:4px;background:#0b0b0b;color:#efefef;font-size:7px;font-weight:850;outline:none}.ixi-aos-commercial-editor .fixed-field-label{height:26px;display:flex;align-items:center;padding:0 7px;border:1px solid #5e552d;border-radius:4px;background:#131313;color:#ffc400;font-size:7px;font-weight:950}.ixi-aos-commercial-editor .field-columns,.ixi-aos-commercial-editor .field-row{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1.15fr) 62px 26px;gap:4px}.ixi-aos-commercial-editor .field-columns{padding:0 4px 4px;color:#6f6f6f;font-size:4.7px;font-weight:900}.ixi-aos-commercial-editor .field-row{margin-bottom:4px}.ixi-aos-commercial-editor .field-row select{width:100%;padding:0 4px}.ixi-aos-commercial-editor .field-row button{width:26px;padding:0}.ixi-aos-commercial-editor .field-row.business-id{padding:4px;border:1px solid #ffc40033;border-radius:5px;background:#ffc40008}.ixi-aos-commercial-editor .add-field{width:100%;margin-top:4px;border-color:#ffc40044;color:#ffc400;background:#131313}
      `}</style>
      <style jsx>{`
        ...
        .clear-fields { border-color: #a34b4b66; color: #dc8c8c; background: #131313; }
      `}</style>
    </div>
  );
}
