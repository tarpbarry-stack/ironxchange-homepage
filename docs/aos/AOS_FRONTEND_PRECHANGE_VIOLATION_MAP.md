...
| System Index assembly | `lib/mos/buildAosSystemIndexes.js:94-143,184-296,397-486` | Durable index objects require canonical IDs, but adapter members remain raw Sharetribe listings, creating a parallel identity universe. Adapter identity is technical, while membership and presentation are still listing-backed. |
