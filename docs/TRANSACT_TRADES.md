...
Automated tests exercise arbitrary trade counts, exact money calculations, private draft creation, response-loss recovery, duplicate prevention, acquisition lineage, stable acquisition identity, gross revenue versus net receivable, actual cash available to settlement, legacy signature compatibility, and return safeguards. The paired stabilization gate passed: 506 frontend tests and 317 backend tests against IX-Core `906cfd5d72a3c019dab32d3c34385891f440c34c`. The production build also passed.

The candidate has not completed browser or authenticated Sharetribe acceptance testing. The workspace browser could not open the local preview and its local Chromium download was unavailable. Before production, verify new and existing trades, photo editing, signing, acquisition recovery, and SOLD at desktop, laptop, and tablet sizes in a test Entity. Do not claim candidate tests as production evidence.
