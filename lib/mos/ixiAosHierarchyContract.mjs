...
export const IXI_AOS_PERSON_ROOT_LABEL = "PERSON";
...
export function resolveAosWorkspaceParentName({
  ...
  if (!parentId) {
    ...
    // The automatically provisioned owner Person is an AOS identity root,
    // not a customer-created System Index container.
    if (objectType === "person" || objectType === "employee") {
      return IXI_AOS_PERSON_ROOT_LABEL;
    }
