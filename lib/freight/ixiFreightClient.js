...
export async function calculateIXIFreightRoute({ origin = {}, destination = {}, provider = "" } = {}, { signal } = {}) {
  return request("/routes/calculate", { method: "POST", body: { origin, destination, provider }, signal });
}
...
export const attachIXIFreightBill = (id, body, options) => action(id, "bill", body, options);
...
export default {
  calculateIXIFreightRoute, createIXIFreightOrder, fetchIXIFreightOrder, fetchIXIAssetFreightOrders,
  requestIXIFreightOrder, awardIXIFreightOrder, dispatchIXIFreightOrder,
  pickupIXIFreightOrder, deliverIXIFreightOrder, attachIXIFreightBill, reconcileIXIFreightOrder,
