...
export function createFamilySample(family = "private") {
  ...
  const publicData = {
    ...
    machineAccess: auction ? "public" : "private", machineChannel: auction ? "auction" : "marketplace",
  ...
  return {
    ...
    auctionObject: auction ? {
      ...
      event: { id: "DEMO-EVENT-01", name: "Sample equipment sale", location: "Abilene, TX" },
      lot: { lotNumber: "1047", sourceUrl: "https://example.com/atlas/sample-wa475" },
