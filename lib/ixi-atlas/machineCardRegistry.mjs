export const ATLAS_REVISION = "2026.09.20";
...
export const machineCardParts = [
  ...
  },
  {
    ...
    specs: [
      ...
      "One Object ↔ One Passport invariant",
      "Resolve before authorized admission",
      "Identity survives presentation changes",
      "Marketplace, Auction, Private and URL Work are envelopes",
    ],
    inputs: ["passportId", "objectId", "aliases", "identity evidence"],
    outputs: [
      "/p/[passportId]",
      "card identity label",
      "shareable object reference",
      "verified envelope bindings",
    ],
    sources: [
    ...
    use: "Use as the permanent identity spine beneath listings, auction lots, protected work and non-owned URL references.",
  },
  {
    id: "family",
    index: "03",
