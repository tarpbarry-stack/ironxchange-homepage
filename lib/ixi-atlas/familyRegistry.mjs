export const atlasFamilies = [
  {
    ...
    faces: [
      ["Review and edit the machine", "Check the title, hours and location. Seller details shows serial and stock numbers. Press EDIT on the card, change a field, then press SAVE. The sample updates here; RESET restores the starting facts.", "The same Object and Passport remain attached after an edit."],
