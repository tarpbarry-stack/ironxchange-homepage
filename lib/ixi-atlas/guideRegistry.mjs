...
export const atlasGuides = [
  ...
  ], "You are working on the intended machine with its current access and inventory state.", ["machine-card", "passport", "sold", "post-free"], "machine"),
  ...
  ], "You can distinguish machine facts from the lot and event information around them.", ["passport", "machine-card"], "identity"),
  ...
  ], "The reference retains its source context and uses the resolved machine identity.", ["passport", "private", "bulk-import"], "identity"),
