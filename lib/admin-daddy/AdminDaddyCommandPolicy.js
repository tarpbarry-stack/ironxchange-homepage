...
const COMMAND_POLICIES=Object.freeze({
 ...
 "media.retry":{capability:ADMIN_CAPABILITIES.MEDIA_RETRY,risk:"medium",requiresReason:true,requiresAudit:true,idempotent:true,targetType:"media-job"},
 "media.reprocess":{capability:ADMIN_CAPABILITIES.MEDIA_RETRY,risk:"high",requiresReason:true,requiresAudit:true,idempotent:true,targetType:"media-job"},
 "media.rebuild-manifest":{capability:ADMIN_CAPABILITIES.MEDIA_RETRY,risk:"high",requiresReason:true,requiresAudit:true,idempotent:true,targetType:"media-job"},
