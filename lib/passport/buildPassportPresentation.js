...
import getSellerLogoUrl from "../seller/getSellerLogoUrl";
...
export function buildPassportPresentation({
  ...
  const resolvedSellerLogo =
  sellerLogo ||
  listing.sellerLogo ||
  publicData.sellerLogo ||
  getSellerLogoUrl(sellerUser || {}) ||
  getSellerLogoUrl(listing.author || {}) ||
  getSellerLogoUrl(listing.seller || {}) ||
  getSellerLogoUrl(listing) ||
  "";
